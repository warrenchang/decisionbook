...
![The book's recurring navigation model follows one decision from attention and interpretation through option construction, prediction and valuation, commitment, action, and learning while other minds, institutions, and designed environments can enter every function. It is an author's teaching synthesis: functions may overlap, repeat, or be skipped.](figures/master-loop.svg){#fig-master-loop fig-alt="The author's recurring navigation model moves from context and information through notice and interpret, construct options, predict and value, choose and commit, act, and observe and learn. An outer layer names other minds, institutions, and designed environments. The functions are not a validated universal stage order and may overlap, repeat, or be skipped."}
