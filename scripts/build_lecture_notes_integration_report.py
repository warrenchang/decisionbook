...
def final_destination(row: dict[str, str]) -> str:
    ...
    mappings = [
        ...
        (("07/market experiment",), "Chapter 24 and Appendix E: market institutions and experimental evidence"),
        (("08 - research methods",), "Appendix E: Running an Experimental Study; Appendix F: replication and research integrity"),
        (("readings / research design",), "Appendix E: experimental design and execution; Appendix F: power, replication, selection, and research integrity"),
        (("readings / ai",), "Chapters 4 and 41 and Appendix E: prediction, AI, and evidence boundaries"),
        (("readings / priming",), "Chapters 13 and 39–41: accessibility, goals, behavior design, and evidence boundaries"),
        (("readings / instructor notes",), "Appendices E and F: experimental workflow, bibliographic verification, replication, and research integrity"),
        ...
        (("01 foundations",), "Chapters 1–7, Chapter 41, and Appendices A, E, and F"),
        (("additional topics / legacy decision theory",), "Chapters 1–2, 16–17, and Appendix A"),
        (("additional topics / neuroscience",), "Chapter 4 and Appendix E; unsupported self-help claims excluded"),
    ]
