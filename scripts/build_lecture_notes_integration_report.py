...
def final_destination(row: dict[str, str]) -> str:
    ...
    mappings = [
        ...
        (("08 - research methods",), "Appendix C: Running an Experimental Study; Appendix E: replication and research integrity"),
        (("readings / research design",), "Appendix C: experimental design and execution; Appendix E: power, replication, selection, and research integrity"),
        ...
        (("readings / instructor notes",), "Appendices C and E: experimental workflow, bibliographic verification, replication, and research integrity"),
        ...
        (("01 foundations",), "Chapters 1–7, Chapter 41, and Appendices C–E"),
        (("additional topics / legacy decision theory",), "Chapters 1–2, 16–17, and Appendix D"),
