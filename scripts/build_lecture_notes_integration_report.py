...
def final_destination(row: dict[str, str]) -> str:
    ...
    if any(term in path or term in group for term in ("term paper", "term-paper", "literature review")):
        return "Appendix E: Conducting and Writing a Literature Review; Appendix F: turning a research gap into a study"
    ...
    mappings = [
        ...
        (("07/market experiment",), "Chapter 24 and Appendix F: market institutions and experimental evidence"),
        (("08 - research methods",), "Appendix F: Running an Experimental Study; Appendix G: replication and research integrity"),
        (("readings / research design",), "Appendix F: experimental design and execution; Appendix G: power, replication, selection, and research integrity"),
        (("readings / ai",), "Chapters 4 and 41 and Appendix F: prediction, AI, and evidence boundaries"),
        (("readings / priming",), "Chapters 13 and 39–41: accessibility, goals, behavior design, and evidence boundaries"),
        (("readings / instructor notes",), "Appendices E–G: literature review, experimental workflow, bibliographic verification, replication, and research integrity"),
        ...
        (("01 foundations",), "Chapters 1–7, Chapter 41, and Appendices A, F, and G"),
        (("additional topics / legacy decision theory",), "Chapters 1–2, 16–17, and Appendix A"),
        (("additional topics / neuroscience",), "Chapter 4 and Appendix F; unsupported self-help claims excluded"),
    ]
