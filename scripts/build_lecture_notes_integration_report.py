...
def final_destination(row: dict[str, str]) -> str:
    ...
    if any(term in path or term in group for term in ("term paper", "term-paper", "literature review")):
        return "Appendix C: Conducting and Writing a Literature Review; Appendix D: turning a research gap into a study"
    ...
    mappings = [
        ...
        (("06/intertemporal",), "Chapter 20: Intertemporal Decision-Making; bridge to Chapter 22"),
        (("06/mental accounting",), "Chapter 19: Mental Accounting"),
        ...
        (("06/money and mind",), "Chapters 19 and 27: mental accounting, finance, and bubbles"),
        ...
        (("readings / instructor notes",), "Appendices C–E: literature review, experimental workflow, bibliographic verification, replication, and research integrity"),
