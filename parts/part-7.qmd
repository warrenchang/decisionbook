...
![Part VII highlights context, option construction, choosing, commitment and action, learning, and design in the book's recurring navigation model—an author's teaching synthesis whose functions may overlap.](../figures/master-loop-part-7.svg){fig-alt="The author's recursive navigation model highlights context, option construction, the combined function of choosing, commitment and action, learning, and the designed environment. A shared rail shows that the social and institutional environment can influence every function. It is not a validated universal stage order."}
