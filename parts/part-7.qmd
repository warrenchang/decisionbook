...
![Part VII highlights context, option construction, action, learning, and the designed environment.](../figures/master-loop-part-7.svg){fig-alt="Context, option construction, action, learning, and the outer layer of designed environments are highlighted."}
