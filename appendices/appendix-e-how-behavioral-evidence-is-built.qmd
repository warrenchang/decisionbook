...
The clinic's question will guide five phases of work. Each leaves a record needed to interpret the next: the question determines the comparison, the design determines what must be recorded, and those records determine which conclusion the analysis can support.
...
With the outcome defined, return to the question the study is meant to answer. The following table connects each kind of claim to the comparison or check it requires.
