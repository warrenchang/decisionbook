...
const out=path.join(root,'audits/elaboration-quadrant-centered-20260925/visual-qa');fs.mkdirSync(out,{recursive:true});
const cases=[['30-persuasion','fig-elaboration-quadrant']];
