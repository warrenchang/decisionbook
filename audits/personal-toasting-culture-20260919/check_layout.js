...
(async()=>{
 ...
 const out='/Users/ra25fi/Library/CloudStorage/OneDrive-AalborgUniversitet/decision_book/audits/personal-toasting-culture-20260919/';
 const checks=[];
 for(const width of [1400,390]){
  ...
  const note=p.locator('.callout.personal-example').filter({hasText:'From my experience: saying “cheers” too often'});
