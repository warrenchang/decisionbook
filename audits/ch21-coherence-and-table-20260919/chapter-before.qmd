...
The comparison in @tbl-wanting-liking connects these experiences to the ways researchers measure them and investigate their neural foundations. **Hedonic hotspots** are small brain regions where particular forms of stimulation can amplify positive reactions to a pleasant stimulus.

[]{#fig-wanting-liking}

| Wanting: motivational attraction | Liking: hedonic pleasure |
| :--- | :--- |
| **Question.** How strongly am I drawn to pursue it? | **Question.** How enjoyable is the experience? |
| **Measurement.** Cue-triggered approach, seeking, and willingness to work for a reward; people can also report their felt urge. | **Measurement.** People's pleasure ratings; in animal studies, characteristic positive facial and mouth reactions to a taste. |
| **Dopamine.** Contributes to the motivational pull of reward cues and the effort invested in pursuit. Some dopamine signals also help update reward predictions. | **Dopamine.** Positive taste reactions can remain after severe dopamine depletion, even when spontaneous pursuit is greatly reduced. Dopamine activity is not a direct measure of pleasure. |
| **Brain circuitry.** Distributed motivation networks include mesolimbic dopamine pathways connecting the midbrain with the nucleus accumbens. | **Brain circuitry.** Rat experiments identify interacting hedonic hotspots in the nucleus accumbens shell and posterior ventral pallidum, within a wider reward network. |
| **Opioids and endocannabinoids.** These systems can also increase eating and reward pursuit; motivation depends on more than dopamine. | **Opioids and endocannabinoids.** Local stimulation of mu-opioid receptors can enhance liking in these hotspots. Anandamide, an endocannabinoid made by the body, can enhance liking in an accumbens hotspot. |
| **Bedtime example.** The next post feels tempting, so the student reaches for another swipe. | **Bedtime example.** The posts provide little enjoyment, even while the pull to continue remains strong. |
: Wanting and liking: experience, measurement, and neural foundations. The neural dissociations and hotspot findings summarized here come from animal experiments (Berridge & Robinson, 1998; Peciña & Berridge, 2005; Smith & Berridge, 2007; Mahler et al., 2007; Schultz et al., 1997). {#tbl-wanting-liking}

A chemical signal's effect also depends on where it acts. In rats, mu-opioid stimulation increased eating across the accumbens shell, but enhanced positive reactions to sweetness only within a small hotspot (Peciña & Berridge, 2005). Wanting and liking are separable functions within interacting networks.

For the student, the practical comparison is between how strongly the next post attracts them and how enjoyable the recent posts actually were. Recording both, alongside the intended and actual stopping time, separates attraction, experience, and the consequence for sleep.
