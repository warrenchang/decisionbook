...
**Scope:** all 87 distinct reader-facing visual assets (89 configured placements because the base loop is deliberately repeated) in the HTML book on 29 August 2026.

**Method:** Each figure was reviewed on a labeled contact sheet (maximum image area approximately 446 × 265 px) and at 100% in its source or PNG fallback. Dense and previously flagged figures were reopened individually. SVG figures were also checked programmatically for parseability, text size at the 820 px book column, connector attachment, visible shaft length, and arrowhead proportion. All 89 HTML placements were then loaded and checked at 1440 px and 390 px. All 88 in-book EPUB placements were extracted and rendered at 768 px and 390 px; the separate cover image was package-validated. EPUB SVGs remain vector-based, while correctly sized PNG fallbacks are retained in the source package. `REVISED` means that the current working-tree version changed during the figure-revision programme; `PASS` means it required no visual change. There are no known `BLOCKED` figures.
...
|---|---|---|---|
| `master-loop.png` | REVISED | Contact sheet; 100% fallback | Geometry, type, and hierarchy corrected; QA pass. |
| `master-loop-part-1.png` | REVISED | Contact sheet; 100% fallback | Stage spacing, shafts, markers, and highlight corrected; QA pass. |
...
| `master-loop-part-2.png` | REVISED | Contact sheet; 100% fallback | Stage spacing, shafts, markers, and highlight corrected; QA pass. |
...
| `master-loop-part-3.png` | REVISED | Contact sheet; 100% fallback | Stage spacing, shafts, markers, and highlight corrected; QA pass. |
...
| `master-loop-part-4.png` | REVISED | Contact sheet; 100% fallback | Stage spacing, shafts, markers, and highlight corrected; QA pass. |
...
| `social-learning-culture.png` | REVISED | Contact sheet; 100% fallback | Flow, labels, and connector scale corrected; QA pass. |
| `mimicry-study-redraw.png` | REVISED | Contact sheet; 100% fallback | Study-result redraw and evidence boundary clarified; QA pass. |
| `norm-message-diagnostic.png` | REVISED | Contact sheet; 100% fallback | Diagnostic lanes and type scale corrected; QA pass. |
| `social-pathways.png` | REVISED | Contact sheet; 100% fallback | Path separation and arrow geometry corrected; QA pass. |
...
| `master-loop-part-5.png` | REVISED | Contact sheet; 100% fallback | Stage spacing, shafts, markers, and highlight corrected; QA pass. |
...
| `master-loop-part-6.png` | REVISED | Contact sheet; 100% fallback | Stage spacing, shafts, markers, and highlight corrected; QA pass. |
...
| `master-loop-part-7.png` | REVISED | Contact sheet; 100% fallback | Stage spacing, shafts, markers, and highlight corrected; QA pass. |
