...
![Cumulative abnormal returns around earnings announcements, grouped by standardized unexpected earnings; higher groups represent more favorable surprises. Continued separation after day zero illustrates post-earnings-announcement drift. Source: Rendleman, Jones, and Latané (1982), as reproduced in the lecture. These are historical portfolio averages, not returns guaranteed to an individual trader.](../figures/finance-earnings-drift-evidence.png){#fig-finance-earnings-evidence fig-alt="Ten earnings-surprise groups diverge around announcement day zero and continue separating over the following 90 days. The most positive-surprise group rises and the most negative-surprise group falls." width=100% .wide-illustration}
