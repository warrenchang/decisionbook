...
| Navigation has 20 compact top-level items | **PASS** |
...
| Appendices A through G are present | **PASS** |
...
| Required content: banana | **PASS** |
| Required content: 33.1% | **PASS** |
| Required content: 25.4% | **PASS** |
| Required content: 36.5% | **PASS** |
| Required content: Replication Crisis | **PASS** |
| Required content: Publication Bias | **PASS** |
...
| Removed acronym from reader package | **PASS** |
| Behavioral Economics is italicized in About | **PASS** |

## Issues

No package, navigation, numbering, date, or required-content issues were found.
