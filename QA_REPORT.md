...
| Appendices | 2 |
| Chapter body words, excluding reference lists | 114,347 |
| Average chapter length | 3,267 words |
| Shortest / longest chapter | 1,127 / 6,143 words |
| Chapter diagrams / unique assignments | 35 / 35 |
| Responsive chapter tables | 36 |
| Global bibliography entries | 477 |
