...
![Target diagrams distinguish systematic error from unwanted variability around a benchmark. Level noise concerns persistent differences in judges’ average levels; pattern noise concerns different reactions to case features. Occasion noise adds within-judge variation across occasions.](../figures/bias-and-noise.svg){#fig-bias-and-noise fig-alt="Four target diagrams compare low and high bias with low and high noise. Separate panels define level noise as persistent differences in judges' average levels and pattern noise as different reactions to case features."}
