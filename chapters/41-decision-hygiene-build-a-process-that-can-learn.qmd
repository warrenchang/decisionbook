...
The table below illustrates the two-stage structure. The case and numbers are hypothetical: a university teacher is deciding whether to pilot an AI-assisted feedback tool. The short record can later contradict convenient memory.
