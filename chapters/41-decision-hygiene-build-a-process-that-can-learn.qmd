...
This chapter brings the book’s tools together around that task: making consequential decisions easier to inspect and learn from.
...
By the time the hiring committee recognizes the chair’s influence, members may no longer be able to recover their independent first judgments. By the review meeting, memory has changed as well. A process that can learn must protect evidence before these losses occur and preserve a connection to the outcome. The workflow in @fig-structured-judgment-pipeline groups the process into six stages. The checklist expands two checks that deserve explicit attention: ground independent judgments in a baseline, then challenge the emerging conclusion before commitment.
...
The [final chapter](42-data-driven-decision-making.qmd#separate-prediction-and-valuation) matters because AI changes the information and assistance available within this process. It brings the book's lessons to a setting in which a forecast or draft analysis can arrive within seconds, while its purpose and consequences still require judgment. Attention determines which problem reaches the agenda; framing shapes the comparison; calibration helps us assess the estimate; social influence affects whether people challenge it; and design connects it to action and feedback. These earlier lessons help us decide what to delegate, what to verify, and which commitments people must own. Chapter 42 brings them together around one practical question: how can better machine assistance strengthen the whole decision loop?
