...
To investigate systematic bias, ask which recurring factor shifts the average away from the defensible target. For noise, distinguish the components below:
...
Now examine the story through six audit questions:
...
The audit can reveal missing options, unsupported predictions, hidden values, invisible opportunity costs, contextual pressures, and feedback that was never designed. Its purpose is prospective: make the next decision more testable than the last one.
...
The part map offers a brief way back into the main workflow: identify the obstacle, choose a change, and check its effect. If a review leaves the next step unclear, use the prompts below to locate the unanswered question. They help select work within the process, rather than add another sequence to complete.
