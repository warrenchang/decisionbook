# Wanting, Craving, and Self-Control
...
Dopamine is not a unitary pleasure chemical. It participates in learning, prediction, motivation, and action across distributed circuits.
:::

::: {.callout-caution .evidence-and-boundary-conditions icon=false}
## Evidence And Boundary Conditions

Clinical addiction can involve withdrawal, medical risk, trauma, and comorbidity. Ordinary habit advice is not a substitute for professional treatment.
:::
...
Choose a behavior you sometimes want more than you like. Write what the urge promises, what usually happens after obeying it, and one way to observe the urge for sixty seconds without acting.  
