...
A useful starting point is therefore to identify what the audience expects and what evidence could change that expectation. Predictive processing offers a **theoretical analogy**, especially from perception and action: incoming information is compared with predictions, and discrepancies can lead to revision (Clark, 2013). The sequence in @tbl-25-model-update turns that idea into practical questions for a message:
...
Classic experiments show why the pause matters. In a low-cost photocopier request, reason-giving increased compliance compared with asking without a reason, even when the stated reason added little information, but the pattern weakened when the request imposed a larger cost (Langer et al., 1978).

[]{#commitment-and-self-persuasion}

Commitment and reciprocity cues can develop through the sequence of requests itself. Consider two invitations to employees. One asks them to test the platform for ten minutes before considering a six-week pilot. Another begins with a large rollout request and, after resistance, retreats to the pilot. The final request may be identical, but the preceding interaction gives it a different meaning.

The **foot-in-the-door technique** starts with a small request before a larger related one. Freedman and Fraser (1966) found that agreement to an initial request could increase later compliance. The **door-in-the-face technique** begins with a larger request that is rejected, followed by a smaller one; Cialdini and colleagues (1975) studied how this apparent concession can encourage reciprocal compliance. [Chapter 36](36-preparing-and-claiming-value.qmd#chapter-36-start) applies the distinction between concessions and independent value to bargaining.

**Self-persuasion** concerns reasons people generate themselves. Ask employees what a worthwhile pilot would need to demonstrate, and let them propose the conditions under which they would support it. Their answers can make the decision intelligible and reveal defects in the proposal. They can also make a position easier to defend: [Chapter 7](07-the-narrator-after-choice-why-reasons-are-not-always-causes.qmd#when-behavior-becomes-evidence-about-the-self) distinguishes dissonance reduction from self-perception, two accounts of how our actions can influence our attitudes. These are possible mechanisms, not interchangeable explanations for every commitment effect.

A useful invitation leaves room to reject the pilot or change one's mind. A small initial “yes” should not hide later costs, manufacture obligation, or be treated as consent to a larger commitment.
...
Respecting the audience’s judgment also means helping it evaluate arguments encountered later. Employees may understand the present proposal yet subsequently hear a misleading claim about what the pilot can establish. Repeating the original presentation may leave them unprepared to assess that claim. Inoculation theory asks whether preparing people to recognize and answer such arguments can protect their judgment. McGuire (1964) proposed that people can be made more resistant to persuasion by exposing them to weakened counterarguments and refutations, much like a vaccine exposes the body to a weakened threat. Inoculation messages warn people that they may encounter persuasion attempts, present common misleading arguments, and refute them. Meta-analyses suggest that inoculation can build resistance across domains (Banas & Rains, 2010).
