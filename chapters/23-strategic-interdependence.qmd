---
aliases:
  - 23-strategic-interdependence-the-best-move-depends-on-other-minds.html
...
>
> — Lewis Carroll, [*Through the Looking-Glass*](https://www.gutenberg.org/cache/epub/12/pg12-images.html), 1871, ch. II
:::
...
## Coordinating through shared expectations {#finding-each-other-in-odense}
...
## Separating preference from prediction {#two-beauty-contests}
...
The two tasks separate **what I prefer** from **what I expect someone else to choose**. A change of answer need not mean your taste changed or that you gave in to social pressure. The incentive changed.
...
## Anticipating how far others reason {#opening-puzzle-should-a-sophisticated-player-choose-zero}
...
### Reasoning and learning about other players {#limited-strategic-depth-level-k}
...
What did people actually choose? In guessing-game results assembled by Camerer, Ho, and Chong (2004), the mean was **37.9 among 20 chief executives**, compared with **19.1 among 136 game theorists**. These selected groups played in different settings; the comparison does not isolate the effect of training or rank their intelligence. It shows why predicting the people in the room matters: even a group familiar with equilibrium reasoning did not collectively choose zero.

Nagel's (1995) experiments found choices consistent with limited steps of reasoning. **Level-*k*** models describe such steps (Nagel, 1995; Stahl & Wilson, 1995): level 0 supplies a starting rule, level 1 responds to it, and level 2 responds to level 1. The familiar 50-to-33-to-22 sequence illustrates the idea.

The starting assumption matters as much as the number of steps. A sophisticated player may choose a relatively high number because they expect others to reason little.
...
Choosing zero by yourself does not put the group in equilibrium. If others choose positive numbers, zero can lose. Your decision still depends on what you have reason to expect from these players. [Coordination and Focal Points](24-coordination-and-focal-points.qmd#chapter-24-start) introduces payoff matrices and develops equilibrium analysis from this starting point.

## Anticipate the response before committing {#application-anticipate-the-response-before-committing}

A manager may propose a new reporting system because it improves their team's work. Other departments may delay adoption because the system is useful only if everyone joins, because they bear more of the transition cost, or because they prefer to keep information private.
...
@tbl-beauty-contest-groups reproduces selected guessing-game results from their Table II. The fitted $\tau$ values in this table were chosen to match the observed mean.
...
The game makes it possible to examine **competition neglect**, when bidders enter without accounting for rivals' persistence, and **escalation of commitment**, when earlier choices make stopping difficult (Staw, 1976). A further bid can also be a forward-looking response to a belief that the rival will stop.
