---
aliases:
  - 07-explaining-our-choices.html
  - 07-narrator-after-choice.html
  - 07-the-narrator-after-choice-why-reasons-are-not-always-causes.html
  - 18-the-narrator-after-the-choice.html
---

# Rationalization {#narrator-after-choice}
...
>
> — François de La Rochefoucauld, [*Maxims*](https://www.gutenberg.org/files/9105/9105-h/9105-h.htm), 1665, maxim 102, translated by J. W. Willis Bund and J. Hain Friswell
:::
...
## Why explanations can miss the causes {#reasons-are-not-the-same-as-causes}

Asking someone why they chose invites **introspection**, examination of their own thoughts and experience. Yet an answer can explain why an option is defensible without identifying what brought it to the person’s attention or made it win. To learn from explanations, we first need to distinguish the roles a reason can play.

A reason can describe a consideration that preceded the choice, justify the choice to an audience, or express a value the person genuinely endorses. It can also be assembled afterward from whatever information is now available. These roles overlap: people often know their goals and conscious deliberations while missing how presentation order, mood, habit, or social pressure influenced them.
...
The sequence in @fig-choice-blindness-swap uses abstract cards to show how the face experiment separates the original selection from the option presented for explanation. Its interest lies in the reasons offered for an undetected substitution: a participant can discuss details of the rejected face as though they motivated the choice (Johansson et al., 2005).

![A choice-blindness switch: a chooser selects one card, receives the rejected card after a covert exchange, and is asked to explain the apparent choice. If the switch is unnoticed, reasons may be offered for the unchosen option.](../figures/choice-blindness-swap.svg){#fig-choice-blindness-swap fig-alt="A three-stage sequence uses striped and dotted abstract cards. The chooser selects the striped card, the cards are covertly swapped during handling, and the dotted card is then presented with the question why did you choose this one." width=100%}

The effect is not confined to faces. In a marketplace study, participants tasted jam or smelled tea, received a covertly switched sample, and sometimes explained why they preferred the option they had not selected (Hall et al., 2010). In a self-transforming moral survey, some participants failed to notice that an item had been reversed and then argued for the position now displayed as their own (Hall et al., 2012). Once an outcome is represented as **my choice** or **my view**, its features supply material for an explanation. The account may express a current preference or value, but it cannot be assumed to recover the cause of the earlier selection.

[]{#the-interpreter-and-confabulation}

The switched face exposes a gap between the choice and its explanation. Neurological cases show another way such gaps can arise. **Confabulation** is a sincerely offered, inaccurate account produced without awareness of its inaccuracy: a plausible explanation is experienced as knowledge.
...
## How actions reshape attitudes {#cognitive-dissonance-the-choice-rewrites-the-chooser}

So far, the explanation has changed while the earlier choice remains fixed. Commitment can also change how the options are valued afterward. A person who chose one appealing job may feel uneasy about the benefits sacrificed by rejecting the other.

**Cognitive dissonance** is aversive tension associated with inconsistency among relevant beliefs, commitments, or actions. Changing a belief is one way to reduce it; changing behavior or finding an external justification can also restore consistency.
...
Responsibility can harden the story. A past choice becomes *my project* or *the decision I defended*, so stopping can feel like admitting that my judgment was poor. Further investment offers the hope of vindicating the earlier choice. This can contribute to **escalation of commitment**: allocating more resources to a course of action despite unfavorable feedback.

In Staw's (1976) simulated business-investment study, participants either made the initial allocation themselves or inherited one made by someone else. After receiving favorable or unfavorable results, they decided how to allocate additional funds. Commitment to the original option was greatest when participants were personally responsible for the initial choice and its results were unfavorable. Responsibility for the earlier decision helped turn bad news into renewed investment.

Organizations add audiences, status, and a shared vocabulary: “the market is not ready,” “execution was the problem,” or “we have come too far to stop.” Any one claim may be true. The danger is an account that can explain every possible result and therefore cannot be wrong.
...
The same distinction applies to an organization's project review. To test “Customers were not ready,” the team needs an observation that would distinguish it from a poor product or an ineffective launch. [Chapter 2's forward-looking comparison](02-structuring-a-decision.qmd#sunk-costs-and-escalation-of-commitment) supplies the question: given what exists now, which option deserves the next investment? A reason for continuing must earn its place through what can still happen.
...
A decision journal supplies the separate record in @fig-narrator-learning: one entry written before outcome knowledge can rewrite memory, and another appended at a specified review point. Unlike a diary, it is organized around a decision rather than a day; unlike an after-action review, it preserves the original alternatives, assumptions, forecasts, values, context, and reasons. Later, compare that untouched entry with what happened. This comparison helps reveal which parts of the explanation were available at the time and which appeared only after the result. [Chapter 41](41-decision-hygiene.qmd#what-a-decision-journal-is) defines the evidence base and every field; [Appendix F](../appendices/appendix-c-portable-course-tools.qmd#one-page-decision-journal) provides the portable template.
...
At that review, do not ask only whether the explanation sounds plausible. Ask whether it had to compete with alternatives.
...
Use @tbl-rationalization-detector to turn a story into claims that can be compared with evidence. A persuasive answer to every question is still a hypothesis; it earns support when it explains observations that plausible rivals do not.

The outcome/process problem was introduced in [*Understanding Decision Making*](01-understanding-decision-making.qmd#outcome-is-not-process). Here the added mechanism is narrative reconstruction: after the outcome, a plausible story can make both the result and the decision feel more inevitable than the original evidence warranted.

The paired judgments in @tbl-process-outcome-review show why a favorable result does not excuse a poor process, and an unfavorable result does not condemn a sound one:
...
A useful record may still be ignored if admitting an error threatens the person who made the decision. Self-affirmation can sometimes reduce defensiveness by reminding people that the whole self is not on trial (Cohen & Sherman, 2014; Steele, 1988). Organizations can also reward revision. A person who says, "My forecast was wrong and here is what changed," should be treated as a source of learning rather than as a threat to authority. Self-reports remain useful records of conscious goals and experience, but confidence in a story is not a test of its causal accuracy.

## Practice Lab

Retrieve one consequential decision and produce a two-page review. Page one uses any records made before the choice to identify options, the best alternative forgone, forecasts, uncertainty, values, and the decision rule. Clearly label details reconstructed from memory. Page two records the outcome, at least two rival explanations, and the evidence that would distinguish them. Finally, reverse the outcome in imagination and write the story you would have been tempted to tell.
