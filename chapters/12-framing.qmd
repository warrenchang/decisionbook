---
aliases:
  - 12-framing-when-the-same-facts-become-different-decisions.html
...
Reference points can also change evaluation. A €60,000 salary may feel generous against an expectation of €50,000 and disappointing against €70,000. This **reference-point shift** changes what counts as a gain or loss. [Chapter 17](17-prospect-theory.qmd#reference-dependence-the-zero-is-psychologically-constructed) develops the model; here we examine how a representation guides attention and comparison (Tversky & Kahneman, 1981).
...
[]{#fig-context-mechanisms}

The clearest tests of framing hold the other ingredients fixed and compare logically equivalent descriptions.
...
The rows of @tbl-disease-framing preserve the same final possibilities and probabilities. The first makes a guaranteed rescue focal; the second foregrounds a guaranteed loss. [Chapter 17](17-prospect-theory.qmd#the-prospect-theory-model) uses the example to examine how reference points and probability weighting can produce that pattern.
...
A restaurant server can ask, “Do you want an egg with your ramen?” Or the server can ask, “Would you like one egg or two?” The second question assumes the decision to add eggs and shifts attention to quantity. It therefore does more than describe equivalent facts differently: it also foregrounds a constrained menu. [Choice Architecture](40-choice-architecture.qmd#choice-architecture-the-environment-gets-a-vote) returns to this overlap and asks whether “no” remains a genuine, easy response.
...
Similarly, describing dissent as a contribution can support speaking up, but language alone does not create psychological safety. [Chapter 28](28-social-influence.qmd#groupthink-a-familiar-but-contested-umbrella) examines the responses to questions and mistakes that make such an invitation credible (Edmondson, 1999, 2019). In politics, competing frames interact with source credibility, prior beliefs, and the audience's values (Chong & Druckman, 2007).
