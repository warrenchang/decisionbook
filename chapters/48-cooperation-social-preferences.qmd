...
| Market action | Judged unfair | Survey N |
| --- | ---: | ---: |
| Raise the price of snow shovels after a snowstorm | 82% | 107 |
| Auction one scarce doll to the highest bidder | 74% | 101 |
| Raise rent to exploit a tenant's location-specific dependence | 91% | 157 |
| Pass through an increase in the wholesale cost of lettuce | 21% | 101 |
| Charge $200 above list price for a scarce car | 71% | 130 |
| Withdraw a $200 discount and return to list price | 42% | 123 |
: Selected fairness judgments from separate historical Canadian telephone-survey samples in Kahneman, Knetsch, and Thaler (1986). “Unfair” combines the two unfavorable response categories; the rows are not one pooled sample. {#tbl-market-fairness}
