...
The model is descriptive and falsifiable. It is not a claim that inequality is the only concern. Bolton and Ockenfels's (2000) ERC model emphasizes one's relative share, while Charness and Rabin (2002) allow concerns for total surplus, the worst-off person, and reciprocity. Efficiency and equality can conflict: giving an extra krone to the better-off person may create several kroner of total benefit, while equalization may reduce the sum.
...
Henrich and colleagues (2001) conducted ultimatum, public-goods, and dictator-type experiments across 15 small-scale societies. Behavior varied substantially. In Lamalera, Indonesia, large “hyperfair” offers and rejections of some high offers have been interpreted in relation to local sharing obligations and whale-hunting cooperation.
