...
In each case, the story can do something a bare statement may not: give the audience a human situation in which an abstract point becomes concrete, causal, emotional, and memorable. The point is not that statistics are weak or that evidence is optional. The point is that decision-makers do not respond to information as neutral recording devices. They interpret information through attention, memory, emotion, identity, social meaning, prior expectations, and imagined futures.

Statistical evidence can estimate averages, distributions, associations, effects, or uncertainty, depending on the design and measure. A story shows what a claim could mean for a particular person in a particular situation. In decision-making, that distinction matters. People rarely ask only, "Is this claim supported?" They also ask, often implicitly: Does this matter to me? Who is affected? What could go wrong? What future does this invite me to imagine? What kind of person would I be if I accepted this claim? What does this choice say about us?

Stories can make these questions easier to imagine than an abstract argument alone. A story turns a fact into a scene, a value into a stake, a trade-off into a conflict, a prediction into a future, and a concept into a decision moment. This is why storytelling belongs in a science of decision-making. Every story contains judgment, prediction, valuation, emotion, social meaning, action, feedback, and learning. In that sense, a story is not separate from decision-making. It is a compressed simulation of decision-making.
...
A story is therefore not merely a decorative opening. It **can** give model updating a protagonist and let an audience simulate the old model meeting trouble before anyone is asked to change belief or behavior in real life. But the AND–BUT–THEREFORE arrangement in @fig-story-update is a writing template, not a scientific definition of narrative, and a compelling story does not establish that a new belief or action is warranted.
...
Third, a coherent causal and emotional structure can provide retrieval cues that isolated data lack. A statistic can be forgotten; in some settings, a concrete character in a consequential situation is easier to retrieve from memory.
...
- **Try this next:** decide whether the message needs a story at all; if it does, carry the diagnosis into Chapter 32 and pair the case with proportionate evidence.
