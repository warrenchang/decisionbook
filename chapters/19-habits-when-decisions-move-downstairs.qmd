...
A habit is a learned cue-response pattern. Wanting is the motivational pull a cue can acquire; liking is the pleasure the outcome actually provides. Self-control improves when people diagnose the loop, redesign the context, and treat an urge as a prediction rather than as a command or moral verdict.
:::

## Learning goals

- Map a repeated behavior from cue ecology through wanting, response, immediate consequence, and learning.
...
Habits compress **Predict**, **Value**, and **Choose** into context-bound policies. Wanting recruits **Act**; consequences update the next loop through **Learn**. Self-control can intervene before the cue, during the urge, or after a lapse.
:::
...
![Habits strengthen when cues repeatedly trigger responses that deliver reward or relief.](../figures/habit-loop.svg){#fig-habit-loop fig-alt="Linear habit loop from cue to urge, response, reward or relief, and learning, with a feedback arrow back to cue."}
