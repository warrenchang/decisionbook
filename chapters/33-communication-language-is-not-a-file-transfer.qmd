...
![In a task involving 29 dyads, senders and receivers forecast high decoding accuracy in both email and voice, while actual accuracy was lower—especially in email (Kruger et al., 2005, Study 2). The estimates describe this task, not a universal channel ranking. The companion schematic contrasts private perspective-taking with perspective-getting through questions and verification (Eyal et al., 2018).](../figures/communication-calibration-evidence.svg){#fig-communication-calibration-evidence fig-alt="Two-panel figure. A grouped bar chart shows sender forecast, receiver forecast, and actual tone-decoding accuracy for email and voice in Kruger and colleagues' Study 2. A flow diagram contrasts imagining another person's perspective, which risks projection, with asking, listening, and verifying, which creates a correctable model." width=95%}
