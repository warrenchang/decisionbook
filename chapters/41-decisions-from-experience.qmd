...
Experience is feedback, but an outcome is an imperfect teacher under uncertainty. The process–outcome distinction introduced in [Chapter 1](01-the-choice-is-the-tip-of-the-iceberg.qmd#outcome-is-not-process) and applied to risky choice in [Chapter 19](39-risky-decision-making.qmd#outcome-bias-a-good-process-can-lose) now meets a further problem: experience supplies only the outcomes actually encountered. A good decision can therefore produce a bad result, a bad decision can be rescued by luck, and an unobserved rare outcome can remain outside the learner's sample.
