...
You now seem to have several reasons for concern. Before treating them as several pieces of evidence, ask whether they all came from the same event.
...
The illustration below invites a first impression about two species. It does not establish their relative ecological importance or the best use of a conservation budget.
...
For a hypothetical exercise, suppose independent evidence showed that protecting the less immediately appealing species would prevent more ecosystem damage per unit of spending. How would you revise an initial allocation? The question separates visual appeal from the evidence needed to pursue a specified conservation goal; the pictures alone cannot supply that evidence.
