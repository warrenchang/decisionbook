...
![A repair procedure moves from the event and private interpretation toward perspective-getting and a shared next action.](../figures/conversation-repair.svg){#fig-conversation-repair fig-alt="Three moves: describe what happened, check the interpretation, and agree what happens next."}

The manager sees a late section and wants to prevent another missed deadline. The colleague hears a judgment about reliability and wants the accusation corrected. Treating either account as the whole problem would leave the other concern unanswered. Separate the event, its felt impact, and the interpretation before choosing what to repair:
