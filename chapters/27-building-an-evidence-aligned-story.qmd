...
An evidence-aligned message begins in the audience's current model, reveals a consequential mismatch, offers a better account, supplies proportionate evidence, and ends with a specific choice. Narrative is one instrument for making that update understandable.
:::
