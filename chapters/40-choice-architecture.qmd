---
aliases:
  - 40-choice-architecture-the-environment-gets-a-vote.html
...
The [amusement-park story in Chapter 12](12-framing.qmd#personal-story-leaving-the-park) shows how a question can offer a small choice within a fixed boundary. From the perspective of choice architecture, the important feature is the **constrained menu**: the child chooses when to leave, while departure itself is settled. The same wording needs more care when the supposedly settled decision is still open.
...
The same principle applies to mental accounting (Thaler, 1985). A budget category can help someone control spending while hiding the total cost across accounts. Show both the local choice and its effect on the whole budget, as discussed in [Chapter 19](19-mental-accounting.qmd#chapter-20-start).
