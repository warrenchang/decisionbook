...
![Subjective value integrates option features with bodily state, goals, memory, identity, social meaning, attention, and comparison.](../figures/valuation.svg){#fig-valuation fig-alt="Multiple personal and contextual inputs converge on subjective value, which then guides attention, motivation, and choice."}
