...
The chapter ends with two immediate bridges. Chapter 5 next examines post-choice narration: why the story told after commitment may not recover the original cause. Chapter 8 later examines expectations: beliefs that can change attention, action, and feedback. Part IV follows repeated action into habit and self-control; Part X turns the book's mechanisms into behavior and decision design.
