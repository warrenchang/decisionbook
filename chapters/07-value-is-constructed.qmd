...
The dependent variable was **response latency**. The mean positive or negative ratings printed beside the pictures in the original materials were normative pretest values used to select the primes; they were not the automatic-priming effect. This distinction matters because a rapid response effect is not a direct measurement of a complete preference.
...
There is no single "value center" in the brain. Value-related signals arise in interacting networks, and fMRI associations do not imply that one region contains a psychological function or determines what a person ought to value.
:::
