...
![Silence, cohesion, apparent unanimity, and a bad outcome do not identify groupthink. Diagnose the pathway with mechanism-specific evidence, then match the safeguard to that pathway.](../figures/silence-mechanism-diagnostic.svg){#fig-silence-mechanisms fig-alt="Five vertically arranged diagnostic cards distinguish directive authority, suppressed dissent, shared-information bias, pluralistic ignorance, and diffusion of responsibility. Each card pairs an observable test with a bounded safeguard. A warning states that silence, cohesion, apparent unanimity, and a bad outcome do not by themselves diagnose groupthink." style="width:100%;min-width:0;max-width:100%;max-height:none;height:auto;"}
...
The informational and normative routes in [Social Norms and Conformity: When Other People Become Evidence](26-social-norms-and-conformity-when-other-people-become-evidence.qmd) can contribute to apparent consensus without being identical to groupthink. [Decision Hygiene](41-decision-hygiene-build-a-process-that-can-learn.qmd) carries the safeguards forward as a repeatable process for independent evidence, structured disagreement, explicit authority, and learning.
...
Other people's actions became evidence in [Social Norms and Conformity: When Other People Become Evidence](26-social-norms-and-conformity-when-other-people-become-evidence.qmd). That chapter distinguishes independent social information from correlated copying, so **social proof belongs there**.

Reciprocity, commitment, scarcity, liking, unity, and reason-giving are examined in [Persuasion: Changing Minds Means Updating Models](30-persuasion-changing-minds-means-updating-models.qmd#influence-cues-are-signals-not-buttons) as conditional signals that can be informative or counterfeited, not as a general-purpose toolkit. Here, the narrower lesson is responsibility: relevant expertise can guide judgment, but no cue transfers moral accountability away from the actor or the institution that designed the role.
