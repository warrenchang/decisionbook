...
Check whether each safeguard reveals previously hidden evidence or disagreement. A formal dissenter can be ignored as merely performing a role, and independent answers cannot supply missing expertise. Psychological safety—a shared belief that interpersonal risk taking is safe—was associated with learning behavior in 51 work teams (Edmondson, 1999); that study did not test it as a cure for groupthink or proof of decision accuracy.
