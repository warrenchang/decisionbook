...
Part III has examined how people choose under risk, time, experience, habit, and mental accounts. But a technically improved decision is incomplete until we ask what it is meant to improve: momentary feeling, remembered experience, life satisfaction, meaning, material security, or some defensible combination may move in different directions. Therefore this capstone makes welfare explicit by naming the person, measure, time horizon, and trade-off—without treating happiness as the sole criterion or assuming that preference and income settle the question.
:::

## Learning goals

- Separate predicted, experienced, remembered, and evaluated well-being across the life of one choice.
- Diagnose forecasting, comparison, and adaptation errors without assuming they erase objective conditions or meaning.
- Build a decision audit that names the person, measure, horizon, distribution, rights, and freedom to revise.
...
Use the Job A–Job B case or a live reversible decision. Produce a one-page timeline with predicted utility before, experienced affect during an ordinary Tuesday, remembered utility after, and life evaluation plus meaning across a longer horizon. Add material security, time, relationships, distribution within the household, and freedom to reverse. State when each measure will be collected and what disagreement among measures would change the choice.
