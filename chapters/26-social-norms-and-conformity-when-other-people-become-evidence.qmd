...
When many people learn from the same visible signal and from one another, social evidence can become a feedback system. [Prices as Social Signals](27-markets-mispricing-and-bubbles.qmd#chapter-27-start) provides a demanding application: price is both an aggregate outcome of earlier judgments and an input into later attention, prediction, and action.
