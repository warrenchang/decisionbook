...
A crowd does not become wise merely by becoming large. Four questions help assess how much its convergence should change a belief.
...
![In both Music Lab experiments, social-influence conditions produced greater cross-world unpredictability than independent-choice benchmarks (Salganik, Dodds, and Watts, 2006). The equal-size cards report the direction of the difference without implying an effect size.](../figures/cultural-market-study-redraw.svg){#fig-cultural-market-study-redraw fig-alt="Two equal-size cards report greater variation across social worlds in both experiments. The panel identifies 7,149 and 7,192 participants, 28 comparisons among eight social worlds averaged across 48 songs, and an independent benchmark based on 1,000 random splits."}
...
Asch-type conformity varies across periods, cultures, tasks, and response conditions (Bond & Smith, 1996). A successful classroom demonstration or norm message therefore needs a new test before it becomes an organizational policy.
:::
...
![Matching postures in a family photograph illustrate behavioral similarity; the image alone cannot establish whether imitation produced it.](../figures/personal-mimicry-crossed-arms.jpg){#fig-personal-mimicry-crossed-arms fig-alt="A young child and an adult stand several metres apart on a cobblestone street with matching crossed-arm postures." width="42%"}
...
Mimicry effects vary with relationship, status, goals, awareness, and how conspicuous the copying becomes. An interaction may feel smoother when people adjust to one another’s tempo, while obvious imitation may feel mocking. Similar movement is therefore a starting observation, not proof of rapport.
