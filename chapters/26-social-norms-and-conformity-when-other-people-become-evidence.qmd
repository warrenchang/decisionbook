...
::: {#chapter-26-start .chapter-epigraph}
> “Whoso would be a man must be a nonconformist.”
>
> — Ralph Waldo Emerson, [“Self-Reliance”](https://www.gutenberg.org/cache/epub/16643/pg16643-images.html), 1841
:::
...
## Learning from other people's choices {#other-people-as-living-data}
...
Before treating agreement as additional evidence, ask where it came from. Four conditions help determine whether the committee’s convergence reflects new information or repetition of an earlier judgment.
...
Second, judgments need some **independence of evidence**. The initial observations or reasons should not all be copies of one visible claim. Ten analysts who used the same vendor report do not supply ten sources. Five interviewers who discussed a candidate after the first interview may have produced one shared impression rather than five assessments.
...
For the hiring committee, these conditions turn “leadership presence” into questions about evidence: what did each member observe, how relevant was it, and which observations were shared? A work sample and a base rate from comparable hires can add information not produced by the room. The meeting procedure developed below preserves initial judgments and then uses discussion to examine their reasons.

## Why we conform: informational and normative influence {#conformity-is-an-outcome-not-a-mechanism}
...
Asch-type conformity varies across periods, cultures, tasks, and response conditions (Bond & Smith, 1996). Use @fig-asch-line-comparison to distinguish your own visual judgment from the response you would give after hearing a unanimous group.

![An Asch-style line-comparison activity. Choose a line before imagining that several people publicly selected a different line first. Then ask what their answers might change: private belief, the social cost of dissent, the public response, or some combination.](../figures/asch-line-comparison.svg){#fig-asch-line-comparison fig-alt="A target vertical line of 170 units appears beside comparison lines A, B, and C. Comparison C is also 170 units. The activity then asks the reader to imagine others publicly choosing B before their turn, and consider whether this changes private belief or the public response." width=100%}

The committee’s nods illustrate the distinction in @tbl-social-alignment-mechanisms: learning something and withholding a doubt can produce the same public agreement.

| Observation | Candidate process | What not to infer |
| --- | --- | --- |
| Others appear better informed, and private belief changes. | Informational influence or social learning | That the evidence is independent or accurate, or that popularity began with quality. |
...
A social norm is not simply a behavior that many people perform. It concerns expectations within a **relevant reference group**: whose behavior is treated as typical, whose approval matters, and what people expect after compliance or violation. Bicchieri (2006) distinguishes **empirical expectations**—beliefs about what relevant others do—from **normative expectations**—beliefs about what relevant others think one ought to do. Both must be distinguished from a person's own preference. [Cooperation and Social Preferences](25-cooperation-and-social-preferences-self-interest-is-not-the-only-payoff.qmd#chapter-25-start) develops how norms and social preferences require different evidence and how norm judgments can be elicited.

In the focus theory of normative conduct, a **descriptive norm** reports what people do, while an **injunctive norm** reports what people approve or disapprove of (Cialdini et al., 1990). The two branches in @fig-norm-message-diagnostic matter because a message can condemn a behavior while advertising that it is common. A late-night email may reveal that many colleagues work late without showing that they approve of the expectation. Silence in a meeting may reveal what people publicly do without revealing what they privately believe.
...
A **dynamic norm** reports a verified direction of change when the desired behavior is not yet common—for example, that more households are reducing food waste—rather than pretending that the majority has already changed (Sparkman & Walton, 2017). [Choice Architecture](40-choice-architecture-the-environment-gets-a-vote.qmd#choice-architecture-the-environment-gets-a-vote) develops when this design can help and the safeguards it requires. People may also underdetect how strongly descriptive norms affect their own behavior, which is one reason introspection alone is a poor norm audit (Nolan et al., 2008).

## Social proof and information cascades {#social-proof-is-a-cue-a-cascade-is-a-mechanism}
...
![Public behavior can influence through two distinct routes. Informational inference can create a cascade without dissent costs; normative pressure can create public conformity without changing private belief. Private estimates, anonymous input, traceable evidence, protected dissent, and support for the first dissenter can preserve independence before discussion.](../figures/social-pathways.svg){#fig-social-pathways fig-alt="Two parallel paths begin with others' public actions. The informational route moves through inferred evidence to possible belief or action updating. The normative route moves through anticipated approval or sanction to public conformity. Both can produce more public actions, with feedback returning to the initial public-action box."}

The parallel routes in @fig-social-pathways show why convergence alone cannot identify either a cascade or conformity pressure. An informational cascade can arise because earlier actions appear informative even when dissent is safe. Normative conformity can arise because disagreement is socially costly even when nobody thinks the majority knows more. The routes can interact, but the evidence needed to test them differs.
...
![In both Music Lab experiments, social-influence conditions produced greater cross-world unpredictability than independent-choice benchmarks (Salganik, Dodds, and Watts, 2006). The cards report directions, not effect sizes.](../figures/cultural-market-study-redraw.svg){#fig-cultural-market-study-redraw fig-alt="Two Music Lab experiments compare social-influence conditions, where download counts are visible, with independent choice, where they are hidden. Social influence produces greater variation across social worlds in both experiments. Samples are 7,149 and 7,192 participants; the measure averages 28 comparisons among eight worlds across 48 songs, with an independent benchmark based on 1,000 random splits."}

Popularity may reflect quality and partly produce the success later used to validate it. The experimental comparison in @fig-cultural-market-study-redraw helps separate those directions by comparing conditions with and without visible download counts, something an ordinary bestseller list cannot do.
...
Use @tbl-22-1 to audit the cue behind an apparent consensus before treating the consensus as additional evidence.
...
When many people learn from the same visible signal and from one another, social evidence can become a feedback system. [Markets, Mispricing, and Bubbles](27-markets-mispricing-and-bubbles.qmd#chapter-27-start) provides a demanding application: price is both an aggregate outcome of earlier judgments and an input into later attention, prediction, and action.
...
### The cognitive capacities behind social learning {#the-social-brain-is-not-simply-the-individually-smartest-brain}
...
The two outcomes in @fig-social-learning-culture show why observation and imitation do not automatically produce useful accumulation. Accumulation also requires some source of variation or innovation, sufficient transmission and retention, and processes that preserve, select, or correct practices across learners or generations. The mixture differs across settings.
...
Similar postures appear in the family scene in @fig-personal-mimicry-crossed-arms. @fig-mimicry-study-redraw compares behavior under different partner conditions, with stronger evidence for the face-rubbing contrast than for foot shaking.
...
Social observation also requires causal explanation. When a colleague misses a deadline, the attribution audit developed in [Confirmation Bias and Motivated Reasoning](10-beliefs-that-defend-themselves.qmd#chapter-10-start) asks which evidence would distinguish character, incentive, information, and constraint accounts before a convenient story selects the next policy.
:::
