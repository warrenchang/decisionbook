...
A public action can update private belief, reveal what a reference group appears to approve, coordinate expectations, or raise the social cost of dissent. Those pathways can produce the same visible alignment. The core task is therefore to treat conformity as an outcome, identify the relevant reference group, and ask how independent the displayed evidence really is.
