...
The same inquiry applies to the hiring committee’s agreement. Four conditions help determine whether convergence reflects new information or repetition of an earlier judgment.
...
[]{#personal-story-following-the-crowd}

::: {.callout-note .personal-example icon=false}
## From my experience: following the crowd despite the sign
...
In the first experiment, both conditions used randomly ordered grids. In the second, the independent list remained randomly ordered, while the social lists ranked songs by downloads. The example menus in @fig-cultural-market-study-redraw make the changing information and order visible.

![Illustrative Music Lab menus; song names and counts are invented.](../figures/cultural-market-study-redraw.svg){#fig-cultural-market-study-redraw fig-alt="Illustrative menus using six invented song names and counts. Experiment 1 contrasts randomly ordered three-column grids without and with download counts. Experiment 2 contrasts a randomly ordered list without counts against a list sorted by its social world's downloads. Actual participants chose from 48 songs." .phone-fit}

In both experiments, visible popularity made success more unequal and more variable across worlds. Quality still mattered, but early differences could grow as later listeners encountered different popularity histories.[^ch26-music-lab] Popularity may therefore partly produce the success later used to validate it.
...
[^ch26-music-lab]: Experiment 1 included 7,149 participants (5,708 social; 1,441 independent); Experiment 2 included 7,192 (5,746 social; 1,446 independent). Cross-world unpredictability averaged differences across 28 world pairs and 48 songs; the independent benchmark used 1,000 random splits (Salganik et al., 2006, supporting materials).
