...
[Chapter 22](19-intertemporal-decision-making-why-later-loses-to-now.qmd#present-bias-and-preference-reversal) explained how present bias can reverse a plan when immediate costs or rewards arrive. Self-control adds the hot-state mechanisms: cues capture attention, wanting intensifies, and an abstract intention must compete with a concrete action available now.
