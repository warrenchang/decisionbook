...
>
> — Ajay Agrawal, Joshua Gans, and Avi Goldfarb, [*Prediction Machines*](https://bpb-us-e1.wpmucdn.com/sites.uw.edu/dist/e/1511/files/2023/05/Prediction-Machines-Simple-Economics-of-AI-2018.pdf), 2018, chapter 2, section “Cheap Creates Value”
:::
...
A pipe-risk model, a chatbot, and a chess-playing program do different jobs, yet all can be described as AI. Treating them as one general-purpose solution makes it difficult to decide what to use. What do these terms tell us about how a tool works and where it can help?
...
The fall in cost is striking. Stanford's 2025 AI Index reports that the inference price of achieving approximately GPT-3.5-level performance on the MMLU benchmark fell from **US\$20 per million tokens in November 2022 to US\$0.07 in October 2024**—a reduction of more than 280-fold (Stanford Institute for Human-Centered Artificial Intelligence, 2025).
