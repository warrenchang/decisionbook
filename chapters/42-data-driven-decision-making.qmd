...
The [previous chapter](41-decision-hygiene-build-a-process-that-can-learn.qmd#ai-accountable-judgment) separated forecasts from the priorities and authority that turn them into a choice. Flint shows why that separation matters: residents could dispute the excavation policy without resolving their dispute by improving the pipe estimates. We will examine what AI can contribute, what decisions its output leaves open, and how to test whether the resulting arrangement works better.
