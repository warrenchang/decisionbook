...
Having neither source leaves the chooser **information-poor**. This becomes **deep uncertainty** when no credible model can yet specify the relevant outcomes and probabilities; it need not remain so if evidence can be obtained elsewhere. With a new technology or an unprecedented disruption, scenarios and reversible trials may be more useful than an unjustifiably precise estimate (Hertwig & Wulff, 2022).
