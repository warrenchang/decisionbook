...
The core mechanism is now in place: the environment generates a path, sampling selects what enters that path, and the encountered path becomes the learned representation. Disaster preparedness and other domains show how that mechanism travels, but they add domain-specific constraints that should not be mistaken for the laboratory paradigm itself.
...
Experience is feedback, but an outcome is an imperfect teacher under uncertainty. The process–outcome distinction introduced in [*How Decisions Should Be Made—and How They Actually Are*](01-how-decisions-should-be-made-and-how-they-actually-are.qmd#outcome-is-not-process) and applied to risk in [*Risky Decision-Making*](16-risky-decision-making-a-probability-is-not-yet-a-feeling.qmd#risk-process-check) now meets a further problem: experience supplies only the outcomes actually encountered. A good decision can therefore produce a bad result, a bad decision can be rescued by luck, and an unobserved rare outcome can remain outside the learner's sample.
