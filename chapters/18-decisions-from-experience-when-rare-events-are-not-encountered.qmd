...
@fig-experience-rare-event-sampling isolates the sampling mechanism. The following sections examine how selective exposure, stopping, and memory shape the experienced record.
...
Hindsight, self-serving attribution, and rationalization make this review difficult. People can sincerely explain choices whose causes they did not notice (Nisbett & Wilson, 1977; Johansson et al., 2005), so a retrospective account needs something firmer than memory to compare with.
