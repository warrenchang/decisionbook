---
aliases:
  - 41-decision-hygiene-build-a-process-that-can-learn.html
...
[Chapter 2](02-structuring-a-decision.qmd#chapter-02-start) clarified alternatives, trade-offs, and information. This chapter brings the behavioral explanations together to build a procedure that keeps those elements open to examination. We will follow what needs to be protected before a discussion, what disagreement can reveal during it, and what a later review can establish from the original record.
...
Once the disagreement is clear, test whether credible differences would change the preferred option. The **sensitivity analysis** introduced in [Chapter 2](02-structuring-a-decision.qmd#stress-test-the-recommendation) becomes a shared check on the recommendation:
...
These tools also depend on the [conditions for speaking up developed in Chapter 28](28-social-influence.qmd#match-the-safeguard-to-the-missing-step). A hiring panel cannot use an independent score that its author feels compelled to withdraw after the chair speaks. Inviting specific dissent, protecting the record, and responding constructively to correction give psychological safety an operational role in the process (Edmondson, 1999).

For the distinct routes by which authority, suppressed dissent, unshared information, pluralistic ignorance, and diffused responsibility can silence challenge, see [Social Influence](28-social-influence.qmd#chapter-28-start).
...
The [final chapter](42-deciding-with-data-and-ai.qmd#separate-prediction-and-valuation) asks what changes when machine assistance makes a forecast or draft analysis available within seconds. The estimate may improve while the decision remains poor because the target is wrong, an important alternative is missing, or nobody can challenge the recommended action. The process developed here gives us a way to test whether the tool improves the whole decision.
