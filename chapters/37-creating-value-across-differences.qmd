...
: Illustrative priority hypotheses to test, not facts about a counterpart {#tbl-33-1}
...
For a separate four-package example, assign **hypothetical, party-specific scores** to the contract-length and delivery trade. These numbers illustrate the logic; they do not reconstruct the opening case.
