...
Groups often rely on authority to coordinate expertise and on witnesses to interpret ambiguous events. But roles and observed inaction can diffuse responsibility until everyone infers that the leader decided, someone else will act, or nothing is wrong. Therefore this chapter examines authority and bystander cues as signals whose meaning can be counterfeited, and shows why safe systems must make evidence, ownership, dissent, and escalation explicit.
:::
