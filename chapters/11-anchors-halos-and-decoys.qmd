---
aliases:
  - 11-when-context-rewrites-comparison.html
...
For the hiring committee, compare work samples on common criteria, then judge the preferred applicant against the actual job requirements. A clear ranking shows who performs better on a measure; the committee still needs to establish how much that difference matters for the work. [Chapter 6](06-valuation.qmd#evaluability-and-attention) connects this distinction to valuation. The [focusing illusion in Chapter 22](22-deciding-for-a-better-life.qmd#focusing-illusion) explains how attention to one clear advantage can displace the rest of a consequential comparison.
...
Return to the hiring committee from [Chapter 1](01-understanding-decision-making.qmd#one-decision-two-questions). It wants evidence of future performance, but must first decide what counts as a plausible candidate and a useful comparison. Context can settle those questions before the evidence is examined.
