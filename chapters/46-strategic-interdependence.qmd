...
A fish-market activity can assign private buyer values and vary available supply across rounds. Run the same underlying values under different trading rules, then compare transaction prices, quantity, total surplus, and how surplus is divided between buyers and sellers. Classroom numbers are outcomes of that implementation—not empirical estimates of real markets. The scientific question is which rule changes price discovery, allocative efficiency, adaptation to a supply shock, and bargaining power, holding the economic environment as constant as possible.
:::
