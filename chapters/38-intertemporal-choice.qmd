...
- Explain how information search can construct apparent patience.
- Interpret a measured discount rate without mistaking it for a pure trait.
...
At 5% annual interest, DKK 1,000 becomes DKK 1,050 after one year, about DKK 1,276 after five years, DKK 1,629 after ten years, and DKK 11,467 after fifty years. Compounding becomes powerful because each year's return also earns later returns. The approximate **rule of 72** says that an amount doubles after about $72/r$ years when $r$ is expressed as a percentage.
...
| --- | --- | --- |
| Utility curvature | DKK 200 may be worth less than twice DKK 100 | Jointly estimate or independently measure curvature |
...
## Profiles, anticipation, and the life that is remembered
...
- MOST—magnitude, opportunity cost, sign, and time frame—provides a compact diagnostic of option attributes.
- Search strategy and task design can alter apparent patience; a measured discount rate is not automatically a pure trait.
...
- Outcome profiles, anticipation, memory, and forecasting connect choice across time to subjective well-being.
...
7. Use MOST to audit one smaller-sooner versus larger-later choice.
8. Explain how an integrative search and a comparative search represent the same choice differently.
9. What should a current textbook say about the original deadline experiment and its 2026 evidence update?
