...
Choice overload becomes more likely when alternatives are complex, preferences are uncertain, the task is difficult, or the chooser is trying to minimize effort (Iyengar & Lepper, 2000; Scheibehenne et al., 2010; Chernev et al., 2015). The aim is a set broad enough to escape tunnel vision and structured enough to remain actionable.
