# Heuristics: Useful Shortcuts in an Uncertain World
...
A label becomes useful when it restores the question that substitution concealed. Complete these five lines before prescribing “more analysis”:

1. **Target question:** What does the decision actually require me to estimate?
2. **Substituted question:** What easier question did my mind answer instead?
3. **Cue:** Which vivid, familiar, emotional, representative, or socially endorsed feature supplied that answer?
4. **Fit:** In this environment, how strongly does that cue predict the target?
5. **Test:** What evidence would answer the target question more directly?

For a surgeon, “How competent will this person be in the operating room?” can become “How confident did this person sound?” For an aviation risk, “How frequent is the event per journey?” can become “How easily can I picture a crash?” For a policy, “What are the expected effects and error costs?” can become “How much do I like the group proposing it?” The detector does not forbid the shortcut. It asks whether the cue has earned the work assigned to it.

The chapters that follow examine specific shortcuts, statistical errors, and contextual mechanisms that can bend judgment. The distinction is important. Heuristics are processes. Biases are systematic errors that may result from those processes. Availability is a shortcut. Overestimating rare vivid events is a bias that can result from it. Representativeness is a shortcut. Ignoring base rates is a bias that can result from it. Affect is a shortcut. Treating dislike as evidence of danger is a bias that can result from it.
...
## When simple rules deserve trust
...
Choose a recent judgment. Complete the five-line heuristic detector: target question, substituted question, cue, environmental fit, and one piece of evidence that answers the target more directly.
