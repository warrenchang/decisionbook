...
Meetings and dashboards allocate attention before any participant begins to reason. @tbl-attention-architecture traces five design choices from what they make visible to what can be missed:
