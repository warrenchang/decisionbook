...
![Six questions connect a decision to well-being: predicted utility and decision utility before the decision, experienced affect during the outcome, remembered utility afterward, and life evaluation plus meaning and purpose across a life. These perspectives are not interchangeable; interpretation depends on the person, time horizon, distribution, objective conditions, and freedom to revise.](../figures/subjective-well-being-six-lenses.svg){#fig-well-being-six-lenses fig-alt="A timeline organizes six perspectives on well-being. Before a choice are predicted utility and decision utility. During the outcome is experienced affect. After the outcome is remembered utility. Across a life are life evaluation and meaning and purpose."}
...
To compare the jobs, we need to distinguish how an ordinary day feels from how a person evaluates the life it belongs to. The OECD distinguishes three components of subjective well-being: life evaluation, affect, and eudaimonia, or meaning and purpose. Work on experienced utility adds a second distinction across time: what a person predicts, chooses, experiences, and later remembers (Kahneman et al., 1997; OECD, 2025).


These perspectives cannot simply be added into one total. Job A could satisfy a valued ambition while reducing sleep and companionship. We will follow the choice through time, then bring the six questions together in a comparison table.

## Before the outcome: predicted utility is a forecast

Many decisions are forecasts in disguise. We choose a home, partner, course, job, holiday, treatment, or purchase partly by imagining how the resulting life will feel. Predicting those feelings is **affective forecasting** (Wilson & Gilbert, 2003). The simulation can spotlight the focal event while leaving the rest of life dim.
...
### Decision utility: what people value when choosing {#decision-utility-is-not-the-same-as-happiness}
...
Differences among these records show what each evaluation emphasizes. They can help explain why an experience we remember fondly is one we would not want to live through again.
...
![Schematic curves summarize three analyses of income and subjective well-being; they are not fitted estimates. The 2010 study found rising life evaluation and apparent flattening of emotional well-being near a US income category around $75,000; the 2021 study found experienced well-being continuing to rise beyond that level; and the 2023 adversarial collaboration found flattening mainly among the least happy part of the distribution.](../figures/income-wellbeing-evidence-synthesis.svg){#fig-income-wellbeing-evidence-synthesis fig-alt="Three schematic panels summarize studies from 2010, 2021, and 2023. The first shows life evaluation rising and affect flattening, the second shows experienced well-being rising with log income, and the third separates a flatter line for the least happy group from a rising line for happier groups." width=100%}

The split between groups in @fig-income-wellbeing-evidence-synthesis shows why one average curve can conceal differences in the relationship. The comparison also remains sensitive to modeling choices. A later reanalysis estimated where the income–well-being curve could bend and found a different plateau pattern (Bennedsen, 2024). The useful lesson is to examine the measure, sample, and model before turning a fitted threshold into a rule for a person’s life.
...
Return to the jobs. A useful comparison starts with the resources and daily conditions each would create: financial security, sleep, time pressure, relationships, and purposeful work. More specific interventions need their own evidence. For example, in an experiment by Dunn, Aknin, and Norton (2008), people assigned to spend money on others reported greater happiness at the end of the day than those assigned to spend it on themselves.
...
The action, horizon, and measures are now specific enough to review. Add what would count as an unacceptable cost, so the test has a clear condition for changing or stopping it.
...
### A policy dashboard for well-being, rights, and distribution {#a-policy-dashboard-not-a-happiness-maximum}
...
## How well-being depends on other people {#bridge-a-better-life-is-not-made-alone}

Subjective well-being begins with a person's experience and evaluation, but the life being evaluated is social. Other people are valued ends, sources of support and conflict, and decision-makers whose actions change what our own options produce. [Strategic Interdependence](23-strategic-interdependence-the-best-move-depends-on-other-minds.qmd#chapter-23-start) begins that expansion by asking what happens when the result of our choice depends on another person’s response. [Connection and Repair](34-connection-and-repair-warm-honesty-makes-truth-usable.qmd#chapter-34-start) later returns to how a difficult conversation can preserve or rebuild connection.
