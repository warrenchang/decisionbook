...
This chapter establishes why a process model is needed. A benchmark for how decisions should be made does not adequately explain how alternatives, beliefs, values, and actions actually arise. The chapter therefore moves from a rational benchmark to six encounters with actual choice and then opens the process between situation and action.
:::
...
- **Independence from irrelevant cues:** a decorative visual cue or a product name in the news should not change choice unless it changes beliefs, values, feasibility, or action costs.
...
These are demanding conditions because actual decisions rarely arrive with their ingredients already defined. Some of the six examples that follow challenge an invariance or regularity condition relatively directly. Others show that a thin model omitted effort, inaction, accessibility, or current motive. The aim is not to declare people irrational six times. It is to ask whether the benchmark, without a richer account of process, predicts what people actually do.
...
The six examples therefore support a precise claim:
...
The six examples can now be located more precisely:
