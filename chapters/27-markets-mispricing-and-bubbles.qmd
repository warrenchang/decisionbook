...
Return to the earnings announcement. A vivid company story can attract [attention](09-availability-affect-and-representativeness.qmd#chapter-09-start), while a subsequent price rise appears to confirm that other investors share your information. If those investors are responding to the same announcement or copying the price, their behavior supplies less [independent evidence](26-social-norms-and-conformity.qmd#chapter-26-start) than it seems.

After buying, the problem changes. You may search for reasons to defend the position, treat its purchase price as the point to recover, or evaluate every fluctuation in isolation. The chapters on [defended beliefs](10-confirmation-bias-and-motivated-reasoning.qmd#chapter-10-start), [mental accounts](19-mental-accounting.qmd#chapter-20-start), and [reference points](17-prospect-theory.qmd#chapter-17-start) explain these possibilities. In a market, their consequences also depend on other traders, the size of the position, and the cost of changing it.
...
Preserve the pre-purchase record to apply the [process–outcome distinction](01-understanding-decision-making.qmd#outcome-is-not-process). A later gain should test the recorded thesis rather than erase weaknesses in the reasoning that produced it.
