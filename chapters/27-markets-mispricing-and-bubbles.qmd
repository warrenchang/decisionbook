...
A constant-growth example makes the sensitivity concrete. If next period's expected dividend is $d_1$, dividends grow indefinitely at rate $g$, and the appropriate required return is a constant $r>g$, then $V_0=d_1/(r-g)$. In a hypothetical example, a dividend of €2, a required return of 8%, and growth of 3% imply a value of €40. Raising assumed growth to 4% increases it to €50. The arithmetic is exact within the model; the difficult work is defending the assumptions, especially growth continuing indefinitely. A low safe interest rate may support higher valuations, but risky equity generally requires a risk premium as well.

The **price-to-earnings ratio**, $P/E$, divides the share price by earnings per share. It summarizes how much investors pay for one year's reported or forecast earnings. It is not generally the number of years needed to recover the purchase price: that interpretation would require constant earnings paid out entirely, with discounting and risk ignored. A high P/E can reflect expected growth, low required returns, temporarily depressed earnings, or overoptimism. When earnings are negative or close to zero, the ratio becomes especially difficult to interpret.

Long historical price-and-earnings charts motivate the question of whether valuations have become detached from plausible future payouts. Shiller's (1981) excess-volatility analysis made this a formal research question. However, a visual gap between two series drawn on different axes is not a valuation test. The **cyclically adjusted P/E ratio**, or CAPE, divides real prices by average real earnings over the preceding ten years to reduce sensitivity to a single year's earnings. Historical valuation peaks, including 1901, 1929, 1966, and 2000, are useful comparisons, not a calendar for the next crash (Shiller, 2000, 2013).
...
Historical accounts often describe an initial opportunity, widening participation, exuberance, distress, and panic (Kindleberger & Aliber, 2011). The lecture's familiar cycle diagram calls these the stealth, awareness, mania, and blow-off phases. Treat that sequence as a possible feedback process:
...
@tbl-historical-bubbles places the episodes discussed in the lecture in chronological order. It preserves their range while distinguishing speculative asset-price booms from broader credit booms and crises. The dates identify broad episodes, not identical national turning points. The central comparison is what investors were buying, what financed the expansion, and how a reversal could spread losses.
...
| Mexico, early 1990s, and several Asian economies, 1992–1997 | Capital inflows; property, equity, and credit expansion in parts of Asia | Reversals of foreign financing add currency and refinancing risks. Mexico's 1994–1995 crisis is distinct from the Asian crisis beginning in 1997. |
...
: Historical episodes discussed in the lecture, with distinctions between asset-price and credit booms. Overview: Kindleberger and Aliber (2011); the detailed cases below supply additional evidence and qualifications. {#tbl-historical-bubbles}
...
The damage spread beyond housing. The S&P 500 lost about 57% between its October 2007 peak and March 2009 trough (Rich, 2013). The lecture's shorter 2007–2008 price window and its international table illustrate the breadth of the sell-off, but a comparison must specify dates, price versus total returns, and currency. A foreign investor's dollar return can differ sharply from the same market's local-currency return. The explanatory task is to trace exposures and financing, rather than assume that simultaneous losses establish identical national bubbles.
...
In the baseline parameterization shown in the lecture, the asset lasts 15 periods and each period's dividend is equally likely to be 0, 8, 28, or 60 cents. The expected dividend is therefore $(0+8+28+60)/4=24$ cents. Immediately before trading in the first period, 15 dividends remain, so the risk-neutral benchmark is $15\times24=360$ cents. It falls by 24 cents after each dividend opportunity, reaches 24 cents before the final dividend, and is zero after the asset expires. A separate lecture example pays 12 or 20 cents with equal probability, giving an expected dividend of 16 cents and an initial 15-period benchmark of $2.40. The two parameterizations should not be mixed.

Participants begin with cash and shares. In a **double auction**, buyers can submit bids and sellers can submit asks while observing other offers. Under the classroom implementation illustrated in the lecture, an incoming order that crosses the best standing offer executes at that standing offer's price. A trader can buy to collect remaining dividends or to sell again during the experiment. A resale changes who receives those dividends; it does not add dividends to the asset.
...
Bubble-like paths are not confined to groups of a dozen participants. Williams (2008) reports large computerized classroom markets, including one with 304 traders that exhibited a substantial boom and crash. Adding traders therefore does not automatically create independent judgments or eliminate feedback. These markets differ from professional exchanges in incentives and institutions, so their size establishes a useful possibility rather than complete field realism.

### Flat fundamentals: the bubble is not just a falling-value task

Many real assets do not mechanically lose one dividend's expected value each short trading period. A useful design therefore pays interest $r$ on cash and gives the asset an expected dividend $d$ each period, with a final redemption payment $R=d/r$. With $k$ periods remaining, the risk-neutral discounted benchmark is

$$
FV_t=\sum_{j=1}^{k}\frac{d}{(1+r)^j}+\frac{d/r}{(1+r)^k}=\frac{d}{r}.
$$

The redemption payment offsets the shortening dividend horizon. In the lecture's examples, $d=\$0.70$ with $r=10\%$ and $d=\$1.40$ with $r=20\%$ both imply a constant benchmark of $7. These are experimental per-period rates, not annual market rates. They also produce different flows of dividends and interest into traders' accounts even though $d/r$ is unchanged.
...
The no-resale result is particularly demanding for a pure greater-fool explanation. If traders cannot profit by passing the asset on, some other source of demand must account for the deviation. Confusion, valuation errors, preferences, and features of the trading task remain candidates. Likewise, less trading when another activity is available does not mean that every field bubble results from boredom.
...
Wang et al. (2018) further found that all-female groups in China produced bubbles comparable to those in all-male groups, and larger than those in all-female U.S. groups. This limits any claim that a single stable gender difference determines market outcomes. Cross-country comparisons also change more than one contextual feature and cannot isolate “culture” as if it were a randomly assigned treatment.

Nadler et al. (2018) tested a different question by experimentally administering testosterone or placebo to male participants. Testosterone administration generated larger and longer-lasting bubbles in that setting. This supports a causal claim about the administered intervention in that sample; it does not identify the source of male–female differences, describe all men's behavior, or show that naturally occurring hormone variation caused a historical crisis.

::: {.callout-note .research-lens icon=false}
## Research Lens: what laboratory markets can transport

These experiments establish that known dividend distributions, an announced horizon, larger groups, or prior experience do not invariably prevent mispricing. They also let researchers test how liquidity, financing, information, and trading rules alter the outcome. Transporting the findings requires comparing those conditions with the field market of interest.[^ch27-laboratory-markets] A historical price chart establishes a trajectory; a controlled treatment comparison can establish the effect of a particular intervention. Neither alone supplies a universal explanation for bubbles.
:::
