...
Imagine that you place an order five minutes after reading the announcement. The company may indeed have exceeded expectations, yet your purchase succeeds only if the price you pay still leaves an attractive return for the risk. Before deciding, record when you learned the news, what reaction you expect from that point onward, and what costs your order would incur. We will return to that record after examining how markets learn.

::: {.callout-note .core-idea icon=false}
## Core idea

Markets can absorb news rapidly while leaving some errors difficult to correct. To judge a price, we need to separate three questions: what information it reflects, whether a plausible trading rule can beat it after risk and costs, and whether it is supported by defensible cash-flow assumptions.
:::
...
The US Federal Reserve’s [policy statement](https://www.federalreserve.gov/newsevents/pressreleases/monetary20130918a.htm) establishes its release at 14:00 on September 18, 2013. To measure how quickly the market responded, an event study must pair that timestamp with price and volume data. The announcement alone cannot establish the reaction.
...
A boom can begin with genuine innovation and later acquire a feedback component. Credit can amplify buying, but neither borrowing nor any other amplifier in the figure is required in every episode.
...
A useful diagnosis should be able to weaken as well as strengthen. Record what currently makes the price look fragile, what could justify it, and which observation would change your assessment. A probability can help when the event and horizon are well defined; an unexplained number adds little.
