...
- Explain negative and positive market feedback; compare historical bubbles and experiments on experience, liquidity, expectations, and trading rules without treating their evidence as interchangeable.
...
### An unfolding shock: September 11

[]{#election-night-the-announcement-may-confirm-what-prices-already-reflect}

[]{#fig-finance-election-night}

On the morning of September 11, 2001, US stock exchanges had not yet opened, but stock-index futures were trading. A **futures contract** sets a price today for settlement against an asset or index at a future date. Trading outside regular stock-market hours makes futures useful for observing early responses to news.

The first plane struck the North Tower at 08:46 US Eastern time. In @fig-finance-september11-futures, futures initially fall and then recover much of that decline. At 09:03, a second plane struck the South Tower, making clear that the events were a coordinated attack. Futures then fell much more sharply, followed by large fluctuations and a partial rebound (National Commission on Terrorist Attacks Upon the United States, 2004; Siegel, 2008).

![S&P 500 futures on September 11, 2001. An initial fall and recovery are followed by a much sharper decline around the second impact. Dashed lines mark the two impact times in US Eastern time. Event times follow the 9/11 Commission (2004). Source: Siegel (2008), Figure 13-1.](../figures/finance-september11-futures.svg){#fig-finance-september11-futures fig-alt="S&P 500 futures from 08:43 to 09:15 on September 11, 2001. After the first impact at 08:46, prices fall and largely recover. Around the second impact at 09:03, prices fall steeply from roughly 1,095 to below 1,070, fluctuate sharply, and partly recover toward 1,080. The curve is traced approximately from the source figure." width=100%}

The first reports left uncertainty about the cause and scale of the event; the second impact changed its meaning. Potential consequences now extended well beyond a single accident. This helps explain why the two impacts were followed by different price responses. Prices can incorporate new information while its full economic consequences remain unknown. A trader who encounters a later account of the attacks faces the price then available, after other traders have already been updating their expectations.
...
![Intraday prices of the four principal shuttle contractors after the Challenger explosion, expressed as percentage changes from their opening prices. The dashed line marks the 11:39 explosion. Morton Thiokol experiences the largest sustained decline. Heavy selling caused an order imbalance, halting NYSE trading in Thiokol from 11:52 a.m. to 12:44 p.m. and creating the gap in observations.[^ch27-thiokol-halt] Source: Maloney and Mulherin (2003).](../figures/finance-challenger-redraw.svg){#fig-finance-challenger fig-alt="Published intraday points for four shuttle contractors, shown as percentage changes from their opening prices. Morton Thiokol falls to about minus 12 percent by the close and has a gap in observations around noon. Lockheed, Martin Marietta, and Rockwell recover part of their initial declines and end about 1 to 5 percent below their opening prices." width=100% .wide-illustration}
...
![Cumulative average excess returns around earnings announcements. Stocks are grouped into ten deciles by standardized unexpected earnings: decile 10 has the most favorable surprises and decile 1 the least favorable. Continued separation after day zero illustrates post-earnings-announcement drift. Approximately digitized from a reproduction of the figure in Rendleman, Jones, and Latané (1982). These are historical portfolio averages, not returns guaranteed to an individual trader.](../figures/finance-earnings-drift-redraw.svg){#fig-finance-earnings-evidence fig-alt="Ten earnings-surprise groups diverge around announcement day zero and continue separating over the following 90 days. The most favorable-surprise group rises to about 8 percent and the least favorable falls to about minus 9 percent. Curves are traced approximately from the source figure." width=100% .wide-illustration}
...
The historical patterns raise a problem: to label a return abnormal, we must first say what return was expected. Suppose a portfolio earns an average of 12% a year. A risk benchmark that predicts 8% leaves four percentage points unexplained; one that predicts 12% leaves none. The observed return is the same, but the judgment about performance depends on whether the benchmark appropriately captures the portfolio's risk.
...
In a competitive bread market, higher prices discourage purchases and encourage supply. With unchanged preferences and costs, a price above the market-clearing level leaves unsold goods, prompting sellers to cut prices; a price below it creates shortages and upward pressure. This **negative feedback** counteracts the initial disturbance.

An asset also offers a possible resale gain. A house-price rise can therefore increase demand if buyers expect further appreciation. At any given current price, higher expected resale proceeds make buying more attractive: the **demand curve shifts outward**, without requiring an upward-sloping demand curve.

Whether prices stabilize depends on which response dominates. Weak extrapolation can leave corrective forces intact; sufficiently strong extrapolation can amplify the shock. This **positive feedback** can reinforce falling prices too. “Positive” means reinforcing, and “negative” means counteracting—not desirable and undesirable ([CORE Econ, n.d.](https://books.core-econ.org/the-economy/macroeconomics/08-financial-environmental-crises-05-model-house-price-bubble.html)).[^ch27-core-price-dynamics]

A hypothetical example separates the two effects. Suppose an asset is expected to pay €2 over the next year and then sell for €40. Buying at €40 gives an expected total return of 5%. If the purchase price rises to €50 while those expectations stay fixed, the expected payoff is still €42: the buyer now anticipates an €8 loss. But if they revise the expected resale price to €55, they anticipate €57 back, a €7 gain or 14% before costs. The new optimism comes from the resale forecast; the payment remains €2.
...
The separate paths in @fig-asset-bubble-feedback allow a boom to begin with genuine innovation and later acquire a feedback component. The price is both an outcome of buying and an input into the next buyer's forecast. Credit can amplify buying, but the loop does not require it. Supply responses and skeptical traders can still restrain it; the relevant question is whether their corrective response outweighs the demand generated by expectations of further gains.
...
**News-timing comparison.** Compare the scheduled Fed announcement with the unfolding September 11 attacks. Identify when new information arrived, how its meaning changed, and when a reader could have acted. Explain what each chart reveals about price adjustment and why reading a headline does not give access to the price that preceded it.
...
[^ch27-thiokol-halt]: The halt applied to NYSE trading. A separate transaction of 50,000 shares took place on Nasdaq at 12:36 p.m., before NYSE trading resumed (Maloney & Mulherin, 2003, Table 2 and note 8).

[^ch27-core-price-dynamics]: CORE’s price dynamics curve plots next period’s price against today’s. Its intersection with the 45-degree line is an equilibrium. In its upward-sloping examples, a slope below one dampens deviations; a slope above one amplifies them. This describes stability under the model’s adjustment rule, not fundamental-value accuracy.
...
::: {.reference}
CORE Econ. (n.d.). Modelling a house price bubble and collapse. In *The Economy 2.0: Macroeconomics* (Unit 8, Section 8.5). Retrieved September 22, 2026, from https://books.core-econ.org/the-economy/macroeconomics/08-financial-environmental-crises-05-model-house-price-bubble.html
:::
...
::: {.reference}
National Commission on Terrorist Attacks Upon the United States. (2004). *The 9/11 Commission report* (Chapter 9). https://9-11commission.gov/report/911Report_Ch9.htm
:::
