...
After a choice, people need explanations to communicate, justify, and learn from what they did. But the mind can build a coherent and sincere story from the outcome, current values, and accessible reasons without recovering the causes that actually produced the choice. Therefore, this chapter separates reasons, justifications, and causes and uses dated records plus rival explanations to keep post-choice learning answerable to evidence.
:::
...
This chapter completes **Commit and act → Observe and learn**. After an outcome arrives, the narrator can compare it with a testable record of the process—or rewrite the past into a story that protects the chooser.
:::
...
People can give sincere explanations for choices without having reliable introspective access to the processes that produced them (Nisbett & Wilson, 1977; Johansson et al., 2005).
...
Sapolsky (2023) extends this causal humility into the stronger “turtles all the way down” argument: reasons and intentions themselves have antecedent causes, which he takes to rule out free will and support less retributive, more preventive and rehabilitative institutions. The evidence here does not settle that dispute; [Appendix B](../appendices/appendix-b-evolutionary-explanations-of-value-choice-and-rationality.qmd#sapolsky-turtles) distinguishes the multilevel causal method from Sapolsky's no-free-will conclusion and from compatibilist alternatives.
:::

The rule that closes this part is simple: **record the forecast before the outcome; evaluate the process after it**. Commitment turns a represented future into action, observation supplies feedback, and learning occurs only if the later story remains answerable to what was believed, valued, and expected before the result was known.

## Practice Lab

Retrieve one consequential decision and produce a two-page review. Page one reconstructs the pre-choice record: options, best alternative forgone, forecast, uncertainty, values, and decision rule. Page two records the outcome, at least two rival explanations, and the evidence that would distinguish them. Finally, reverse the outcome in imagination and write the story you would have been tempted to tell.

## Take it forward

- **Use this when:** success, failure, or identity makes one post-outcome explanation feel obvious.
- **Do not infer:** that sincere reasons are complete causes, that one favorable outcome validates the process, or that introspection is worthless.
- **Try this next:** record the forecast before the outcome; review the process after it.
