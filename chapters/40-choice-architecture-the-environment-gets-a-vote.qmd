...
[Chapter 2](02-building-a-better-decision-alternatives-opportunity-cost-information-and-robustness.qmd#construct-the-feasible-set) asked the chooser to look beyond the first visible alternatives. Here the question is how a menu designer can support that work. A menu appears to give people freedom, yet even a clear display can hide a useful combination, make delay invisible, or omit the option of gathering more information. The first design task is therefore to construct the option set before polishing its presentation. Categories and order then shape comparison: people interpret an option relative to what appears beside it.
