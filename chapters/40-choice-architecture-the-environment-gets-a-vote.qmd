...
Behavior design can help one person act on an endorsed goal, and every institution also designs the path through which many people notice options, understand consequences, act, and learn. But the same architecture can expand practical agency or exploit limited attention, effort, and inference in service of someone else's objective; a nudge changes the path without forbidding options or substantially changing material incentives. Therefore this chapter asks how to design and test choice environments that improve understanding and action while preserving welfare, meaningful exit, and refusal.
:::
...
![The plausible-path model is an author's hypothesis map from objective through menu, understanding, action, and feedback. Each proposed link and lever must be diagnosed, tested, and governed rather than assumed.](../figures/choice-architecture.svg){#fig-choice-architecture fig-alt="An author's hypothesis map connects objective, menu, understanding, action, and feedback. Aligned levers and a governance bar indicate relationships to test, not a validated universal sequence."}
