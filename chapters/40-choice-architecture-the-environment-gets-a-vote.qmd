...
![The same hotel offer before and after a bundled interface redesign. The second version makes the next action prominent with an arrow. Google reported higher clicks after combining the arrow with typography, spacing, and layout changes.](../figures/digital-arrow-affordance.svg){#fig-digital-arrow-affordance fig-alt="Two generic hotel advertisements show the same offer. The second contains a prominent right-pointing arrow. A result box reports higher clicks after Google's bundled redesign." width="100%"}
