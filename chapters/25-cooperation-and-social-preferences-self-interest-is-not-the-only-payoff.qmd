...
Strategic models can show when cooperation is sustainable, and observed cooperation can reveal that a social system produced coordinated action. But the action does not identify the motive: repetition, reputation, punishment, communication, group boundaries, norms, or concern for others can produce cooperation, while distrust or punitive incentives can produce defection. Therefore this chapter separates material incentives, beliefs, social preferences, and social norms before drawing conclusions about cooperative or selfish character.
:::
...
Cooperation extends **Coordinate** across time. Future consequences, institutions, concern for others, norms, and identity can all change the experienced payoff—even when the material action looks the same.
:::
...
## Movement 2: what people value socially
...
@fig-social-preference-games-redraw shows why a result cannot be separated from the action set that produced it. The numerical ranges redraw findings summarized by Forsythe et al. (1994), Hoffman et al. (1994), Camerer (2003), and Oosterbeek et al. (2004); the graphic design is original, and the boundaries prevent the ranges from becoming claims about a universal human type.

::: {.callout-note .research-lens icon=false}
## Advanced research track: identify social preferences by contrast

This optional track is for readers designing or interpreting social-preference studies. The applied lesson does not require estimating a moral “type”: observe choices across conditions that separate concern for outcomes, intentions, expectations, and enforcement.
...
Kahneman, Knetsch, and Thaler (1986) asked separate samples of respondents to judge market practices. @fig-fairness-entitlements-redraw shows four selected historical vignettes. The two car questions provide the cleaner framing contrast because the final list price is the same but its path differs. The snow-shovel and lettuce questions are not a controlled pair: the products, circumstances, price changes, and samples also differ.

![Four selected fairness judgments from Kahneman, Knetsch, and Thaler (1986), redrawn from the reported values. A post-storm snow-shovel increase was rated unfair or very unfair by 82% of respondents, and a lettuce wholesale-cost pass-through was rated unfair by 21%. Charging $200 above a scarce car's list price was rated unfair by 71%, compared with 42% for withdrawing an equivalent $200 discount. Each row is a separate historical Canadian sample; the results are descriptive and do not define universal or normative fairness.](../figures/fairness-entitlements-redraw.svg){#fig-fairness-entitlements-redraw fig-alt="Four horizontal bars report the percentage rating a market action unfair or very unfair. Snow-shovel price rise after a storm is 82 percent, lettuce wholesale-cost pass-through is 21 percent, a scarce-car surcharge above list is 71 percent, and withdrawal of an equivalent discount is 42 percent. Sample sizes are shown, and the footer identifies separate Toronto and Vancouver samples from 1984 to 1985 and warns against universal or normative interpretation." width=100%}
