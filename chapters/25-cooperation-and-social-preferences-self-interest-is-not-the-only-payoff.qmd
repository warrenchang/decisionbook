...
Giving that remains is not a pure generosity parameter. Anonymity, earned entitlement, experimenter observation, and whether the menu allows taking as well as giving can change the meaning of the action.
...
Andreoni and Miller (2002) gave 176 participants 8–11 allocation choices at varying prices of giving, producing more than 1,600 decisions. Eighteen of the 176 participants violated at least one of the revealed-preference axioms tested. Only three—fewer than 2%—had violations classified as severe using a critical cost efficiency index below 0.95. The small severe-violation rate supports approximate consistency for most participants; it should not be reported as the rate of any violation.
...
Kahneman, Knetsch, and Thaler (1986) asked separate samples of respondents to judge market practices. @fig-fairness-entitlements-redraw shows four selected historical vignettes. The car questions hold the size of the price increase at $200 but vary its relation to list price: one adds a surcharge above list, while the other removes a discount below list. Their final prices are different, so this is not a comparison of identical final prices. The snow-shovel and lettuce questions are not a controlled pair: the products, circumstances, price changes, and samples also differ.

![Four selected fairness judgments from Kahneman, Knetsch, and Thaler (1986), redrawn from the reported values. A post-storm snow-shovel increase was rated unfair or very unfair by 82% of respondents, and a lettuce wholesale-cost pass-through was rated unfair by 21%. Charging $200 above a scarce car's list price was rated unfair by 71%, compared with 42% for withdrawing a $200 discount. Each row is a separate historical Canadian sample; the results are descriptive and do not define universal or normative fairness.](../figures/fairness-entitlements-redraw.svg){#fig-fairness-entitlements-redraw fig-alt="Four horizontal bars report the percentage rating a market action unfair or very unfair. Snow-shovel price rise after a storm is 82 percent, lettuce wholesale-cost pass-through is 21 percent, a scarce-car surcharge above list is 71 percent, and withdrawal of a $200 discount is 42 percent. Sample sizes are shown, and the footer identifies separate Toronto and Vancouver samples from 1984 to 1985 and warns against universal or normative interpretation." width=100%}
