# Biases: Predictable Errors and the Stories That Sustain Them
...
These stories matter because they protect the bias from correction. Chapter 5 examines rationalization as the story after the choice. In many biases, the story begins even earlier. It accompanies the judgment while it is being formed.
...
The lecture's photographs of famous delayed projects and its “18-month light-rail” slide serve the same diagnostic purpose, but the photographs and course graphic are unnecessary. Run the case directly: a city team proposes an 18-month schedule while comparable projects usually finish late and over budget. Before hearing why “this project is different,” write the reference-class completion range; then list only the genuinely diagnostic differences that justify moving away from it. The exercise turns a visual catalogue of overruns into an outside-view test.
...
Take one belief you strongly prefer to be true. Write the evidence that would change your mind, where you would look for it, and why you might be tempted to dismiss it.  
