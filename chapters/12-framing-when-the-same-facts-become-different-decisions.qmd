...
*When the Same Facts Become Different Decisions*

::: {#chapter-12-start .chapter-epigraph}
> “There is nothing either good or bad but thinking makes it so.”
>
> — William Shakespeare, [*Hamlet*](https://www.folger.edu/explore/shakespeares-works/hamlet/read/2/2/), c. 1600, Act II, scene ii
:::
...
Reference points can also change evaluation. A €60,000 salary may feel generous against an expectation of €50,000 and disappointing against €70,000. This **reference-point shift** changes what counts as a gain or loss. [Chapter 17](17-prospect-theory-gains-and-losses-begin-at-a-reference-point.qmd#reference-dependence-the-zero-is-psychologically-constructed) develops the model; here we examine how a representation guides attention and comparison (Tversky & Kahneman, 1981).

::: {.callout-note .personal-example icon=false}
## From my experience: a fall becomes a somersault {#a-personal-illustration-from-a-fall-to-a-somersault}
...
Describing the fall as an impressive performance offered a less threatening interpretation, which may have changed her emotional response. Safety and validation must come first. A calm, reassuring frame can sometimes reduce fear, but it should never deny injury, dismiss pain, or require another person to feel differently.
:::

The fall was given a different meaning while the event itself remained fixed. Other changes to a message can operate differently. A **prime** changes the mental context before or around a judgment; **fluency** concerns the ease of processing it; a **default** changes what happens without an active response. A donation form can combine reassuring language, readable typography, and an opt-out default, so finding a change in participation would not by itself identify a framing effect.

## Equivalent facts, different meanings

![Framing, priming, fluency, and defaults influence choice through different mechanisms.](../figures/context-mechanisms.svg){#fig-context-mechanisms fig-alt="Four cards distinguish framing, priming, fluency, and defaults by the question each mechanism answers." .phone-fit}

In @fig-context-mechanisms, the relevant distinction is what changed: the description, the preceding cue, processing ease, or the result of inaction. The clearest tests of framing hold the other ingredients fixed and compare logically equivalent descriptions.
...
A gain frame invites the audience to consider what acting could achieve; a loss frame emphasizes what failing to act could cost. Whether either improves understanding or changes behavior depends on the particular message and setting.

A third category is **risky-choice framing**, illustrated by Tversky and Kahneman's (1981) hypothetical disease problem. Six hundred people are at risk, and the chooser must select one of two programs.

::: {.callout-note .predict-first icon=false}
## Choose before reading the result

[Predict first]{.reading-label}

Read the first row and record your choice. Then read the second row. Assuming the stated outcomes are complete, would you choose the corresponding program again?

| Description | Sure program | Risky program |
| --- | --- | --- |
| Lives saved | 200 people survive. | One-third chance that all 600 survive; otherwise nobody survives. |
| Lives lost | 400 people die. | One-third chance that nobody dies; otherwise all 600 die. |
: Two descriptions of the same programs {#tbl-disease-framing}
:::

Of the **152 respondents** given the lives-saved version, **72% chose the sure program**. In a different group of **155** given the lives-lost version, only **22% chose it**; **78% preferred the gamble**. The majority preference reversed across descriptions.

The rows of @tbl-disease-framing preserve the same final possibilities and probabilities. The first makes a guaranteed rescue focal; the second foregrounds a guaranteed loss. [Chapter 17](17-prospect-theory-gains-and-losses-begin-at-a-reference-point.qmd#the-prospect-theory-model) uses the example to examine how reference points and probability weighting can produce that pattern.
...
![Two questions make different options salient. “Do you want an egg?” keeps no and yes visible, whereas “Would you like one egg or two?” makes eating implicit and asks only about quantity.](../figures/assumed-choice-eggs.svg){#fig-assumed-choice-eggs fig-alt="Two side-by-side menu panels. The first asks whether the person wants an egg and displays no and yes. The second asks whether the person wants one or two eggs and displays only one and two. The second question makes adding an egg implicit." width=100%}

In @fig-assumed-choice-eggs, adding “no egg” restores an option hidden by the second question. “Would you prefer delivery this week or next week?” similarly treats purchase as settled. These are cases of **substantive reframing**: the inquiry changes which options, objectives, or causal accounts receive consideration. They deserve scrutiny even though they are not tests of equivalent numerical descriptions.

::: {#personal-story-leaving-the-park .callout-note .personal-example icon=false}
## From my experience: leaving the amusement park

When it is time to leave an amusement park, I have learned to ask my daughter, “Do you want to leave now or in five minutes?” If I ask only, “Do you want to leave now?”, she usually says no: she wants to keep playing. With the second question, she almost always chooses “In five minutes.” Sometimes she even reminds me that the five minutes are up and we should leave.

The question shifts the decision from *whether* to leave to *when* to leave. Compared with demanding an immediate departure, it gives her a small part of the decision to make herself. My impression is that this makes leaving feel more like carrying out her own plan. The five minutes also give her time to prepare for the transition.

The choice works as a shared agreement when I can genuinely accept either answer and honor the extra time. Leaving is the boundary; the timing is hers to choose.
:::

A question can therefore shape both the options considered and the person's sense of autonomy. Having a meaningful say can support willingness to act; self-determination theory connects such ownership with more autonomous motivation (Deci & Ryan, 2000). The practical opportunity is to make clear what must happen while inviting a real choice about how or when it happens.
...
The sales team can check its frame by stating which observation would support each explanation.
...
Loftus and Palmer (1974) showed 45 students seven films of car accidents, varying one verb in the speed question across five groups of nine. Mean estimates ranged from **31.8 mph** for “contacted” to **34.0 mph** for “hit” and **40.8 mph** for “smashed.” The cars on film had not sped up; a word in the question produced a nine-mile-per-hour spread in the estimates.

That first result could reflect a changed report without a changed memory. A second experiment therefore asked about broken glass one week later. There was none in the film, yet **16 of 50** students previously asked about “smashed” reported seeing it, compared with **7 of 50** asked about “hit” and **6 of 50** controls who received no speed question. @fig-wording-memory-study-redraw keeps the immediate estimate and later report separate.

![Question wording changed both immediate speed estimates and later reports of nonexistent broken glass. Published values from Loftus and Palmer (1974).](../figures/wording-memory-study-redraw.svg){#fig-wording-memory-study-redraw fig-alt="A two-panel original chart. In Experiment 1, with 45 students in five groups of nine, mean speed estimates rise from 31.8 miles per hour for contacted to 40.8 for smashed. In Experiment 2, with 50 students per group, 32 percent of the smashed group reported broken glass versus 14 percent of the hit group and 12 percent of controls, although no broken glass appeared."}

The results concern speed estimates and later reports, with the second experiment supporting an influence of wording beyond the immediate estimate. They fit a broader account of reconstructive memory (Bartlett, 1932). The **misinformation effect** names a related pattern: misleading information encountered after an event can distort later reports of what happened (Loftus, 2005). A confident recollection therefore needs a source history as well as a vivid description.
...
Entman’s (1993) account of communication framing connects these steps: highlighting particular features can define a problem, suggest its cause, imply a moral judgment, and favor a remedy. “The employee ignored the client” already proposes both conduct and responsibility. If accepted without examination, that frame can guide action before the cause has been established.

## Reframing decisions in practice {#framing-in-management-negotiation-and-policy}

Framing a negotiation as joint problem-solving can invite the information needed to discover a useful trade. But sharing that information can also expose a party to pressure. Calling the meeting a battle instead can emphasize winning and withholding while hiding possible agreement. A useful frame must guide the search without settling the disclosure decision in advance: the parties still need to assess incentives, alternatives, and safeguards.

Similarly, describing dissent as a contribution can support speaking up, but language alone does not create psychological safety. [Chapter 28](28-authority-groupthink-and-shared-responsibility.qmd#groupthink-a-familiar-but-contested-umbrella) examines the responses to questions and mistakes that make such an invitation credible (Edmondson, 1999, 2019). In politics, competing frames interact with source credibility, prior beliefs, and the audience's values (Chong & Druckman, 2007).
...
When recommending the procedure, show both the expected reduction in errors and the additional workload. Selecting only the most persuasive true sentence can hide that trade-off. Distinguish the evidence for each consequence from the priorities that make one more important to the decision.
...
The same care applies in management. A label such as “rightsizing” should not obscure job losses, and calling a workload a “stretch goal” does not establish that it is sustainable. The safeguards in @tbl-15-1 follow what the frame changed: restate equivalent quantities, reopen missing alternatives, or test an implied cause.
...
Take one consequential decision statement and produce a paired-frame brief. Where quantities permit, compare gains and losses, absolute and relative quantities, or final states and changes, checking that each pair describes equivalent outcomes. Also compare the consequences for an individual with those for the wider system, marking these as additional perspectives rather than equivalent facts. For each comparison, record what becomes visible and what recedes. End with the version you would show a decision-maker and explain why it preserves relevant choice rather than steering toward your preferred answer.
