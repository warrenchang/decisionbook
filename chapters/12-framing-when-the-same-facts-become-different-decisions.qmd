...
Of the **152 respondents** given the lives-saved version, **72% chose the sure program**. In a different group of **155** given the lives-lost version, only **22% chose it**; **78% preferred the gamble**. The majority preference reversed across descriptions. These are comparisons between groups, not a count of individuals who changed their minds.
...
The sales team can check its frame by stating which observation would support each explanation. The next section shows why recording observations before asking a leading question matters as well.
