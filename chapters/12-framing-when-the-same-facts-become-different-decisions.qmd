...
The same facts can support a decision only after they have been organized into a problem, a reference point, and a set of consequences. But a frame can shift what receives attention, what counts as gain or loss, and which causes or responsibilities become visible without changing the underlying facts. Therefore, this chapter treats framing as part of reasoning and develops a complementary-frame protocol for revealing consequential alternatives without pretending that wording is neutral.
:::
...
Framing acts mainly at **Interpret** and **Value**. It changes what a decision appears to be about, which reference point becomes salient, and which consequences receive weight.
:::
...
A restaurant server can ask, “Do you want an egg with your ramen?” Or the server can ask, “Would you like one egg or two?” The second question assumes the decision to add eggs and shifts attention to quantity. It therefore does more than describe equivalent facts differently: it also foregrounds a constrained menu. [Choice Architecture](40-choice-architecture-the-environment-gets-a-vote.qmd) returns to this overlap and asks whether “no” remains a genuine, easy response.
...
![Question wording changed both immediate speed estimates and later reports of nonexistent broken glass. The chart is an original redraw of the published values, not a reproduction of the journal artwork.](../figures/wording-memory-study-redraw.svg){#fig-wording-memory-study-redraw fig-alt="A two-panel original chart. In Experiment 1, mean speed estimates rise from 31.8 miles per hour for contacted to 40.8 for smashed. In Experiment 2, 32 percent of the smashed group reported broken glass versus 14 percent of the hit group and 12 percent of controls, although no broken glass appeared."}
...
- **Use this when:** wording, reference points, or problem definitions may be changing what enters the decision.
- **Do not infer:** that every framing effect proves irrationality or that any single frame is neutral and complete.
- **Try this next:** present the strongest complementary frame before asking for commitment and record whether the decision changes.
