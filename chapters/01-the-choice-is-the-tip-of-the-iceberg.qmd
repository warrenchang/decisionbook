...
![Decision-making according to behavioral evidence. Presented information enters judgment, but judgment is shaped by prediction, valuation, selection and interpretation of information, internal state and model, external context, choice, outcome, and feedback.](../figures/decision-making-according-to-behavioral-evidence.svg){#fig-behavioral-decision-loop fig-alt="Diagram of behavioral decision-making. Presented information on alternatives enters a judgment system inside the decision-maker. Judgment includes prediction, valuation, and the selection and interpretation of information. Internal state and model shape interpretation. External context shapes both presented information and internal processing. Judgment leads to choice, then outcome, then feedback and learning."}

Figure @fig-behavioral-decision-loop makes the architecture more explicit than the simple loop. It keeps the core distinction between **prediction** and **valuation**, but adds two important features. First, the decision-maker does not process all available information. What matters behaviorally is **presented information on alternatives**: the subset of information that enters the person's model through attention, framing, defaults, salience, and social context. Second, the center of judgment is not only prediction and valuation, but also the **selection and interpretation of information**. People do not merely receive evidence; they filter, weight, and interpret it.

The diagram also shows two upstream influences that will matter throughout the book. **External context** includes frames, defaults, option sets, information format, friction, social cues, and primes. These factors help determine what information is encountered and how it is processed. **Internal state and model** includes attention and cognitive resources, beliefs, goals, affect, memory, identity, and the person's causal model of the world. These internal factors help explain why the same situation can be interpreted differently by different people—or by the same person at different moments.

Prediction and valuation are shown as mutually influencing one another because beliefs about what is likely and feelings about what matters rarely stay separate for long. Hope can inflate confidence; fear can amplify perceived risk; moral commitment can make one outcome loom larger than another. Both prediction and valuation then shape how information is selected and interpreted. The resulting judgment guides **choice**, which produces an **outcome**. Outcomes do not end the process: they create **feedback and learning**, which update the future decision-maker rather than simply adding a final score to the past decision.

This richer diagram better captures what behavioral evidence shows: choices are not produced by detached calculation alone. They emerge from a system in which information, attention, context, memory, affect, interpretation, and feedback interact. The loop remains a useful abstraction, but the more detailed model clarifies where systematic bias, disagreement, manipulation, and improvement can enter.
...
- Separate prediction from valuation.
- Distinguish decision quality from outcome quality.
- The book will later separate normative benchmarks, descriptive explanations, and prescriptive methods; Chapter 1 only introduces that roadmap.
