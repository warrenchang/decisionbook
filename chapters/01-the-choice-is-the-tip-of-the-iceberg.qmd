...
Choose one important decision. Draw the loop from information and alternatives through prediction, valuation, choice, outcome, and feedback. Name the best feasible alternative that commitment would cut off, and assess whether the current option set is too narrow, manageable, or overwhelming. Mark one place where the process could be redesigned.
