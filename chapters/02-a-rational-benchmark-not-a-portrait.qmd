...
**Decision hygiene is a central prescriptive approach.** It treats judgment quality as a property of a system rather than only a personal virtue. Structured interviews, rubrics, checklists, independent estimates, noise audits, premortems, decision journals, calibration exercises, and review procedures are prescriptive because they are designed to reduce avoidable error and improve learning (Kahneman et al., 2021). Chapter 48 develops this approach in detail.
