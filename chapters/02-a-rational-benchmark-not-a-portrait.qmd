...
Rationality is a benchmark for making alternatives, beliefs, values, constraints, and trade-offs inspectable. It improves a decision only when the problem itself has been built well.
:::
