...
Formally, the expected value of information is the expected value achievable after learning minus the expected value achievable without learning. Net value subtracts the cost of obtaining and acting on the information. The practical version requires no false precision: list the possible results, state what action follows from each, and ask whether any branch differs. If no plausible answer changes action, the request may be serving reassurance or delay rather than decision quality.
