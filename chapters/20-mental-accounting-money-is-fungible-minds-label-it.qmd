...
>
> — Richard H. Thaler, [“Mental Accounting Matters”](https://onlinelibrary.wiley.com/doi/10.1002/%28SICI%291099-0771%28199909%2912%3A3%3C183%3A%3AAID-BDM318%3E3.0.CO%3B2-F), 1999, p. 183
:::
...
The tennis example concerns a payment that keeps influencing whether to play. How long does that influence last? A gym membership buys access throughout the paid period, yet a fresh bill can make going feel more urgent, as if each visit repays the purchase. Researchers describe this link between payment and consumption as **coupling**.
...
These hypotheses concern the experience of the separate entries; they do not make it acceptable to conceal their total. Releasing bad news as one opaque bundle may hide material information. Separating trivial positive features can distract from a large loss. Ethical presentation keeps the total recoverable even when experience is staged.
...
### Diversification: when the menu becomes the portfolio {#when-the-menu-becomes-the-portfolio}

When people allocate across several options at once, they may use a simple **1/n heuristic**, also called **naive diversification**: divide resources approximately equally among the available categories. If a retirement menu offers one stock fund and one bond fund, equal division implies 50% stocks. Adding a second stock fund can shift the same rule to two-thirds stocks even though the investor's goals and risk tolerance have not changed (Benartzi & Thaler, 2001).
...
### Daily income targets {#boundary-case-daily-income-targets}

A high-wage day makes each extra hour more rewarding, but it also brings a daily earnings target within reach sooner. Those comparisons can point toward different stopping times. The driver needs to decide whether another hour’s income is worth the leisure it displaces.
...
A budget helps protect money for a purpose, yet the same boundary can make a worthwhile purchase seem unaffordable while funds sit elsewhere. The audit needs to preserve the useful protection and expose the costly restriction. Use @tbl-mental-accounting-audit to reconstruct the decision twice, comparing the existing account with the alternatives and future costs that its boundary may hide:
...
The same design choice can protect or exploit. Separating savings from everyday spending can preserve a goal; separating a product price from unavoidable fees can hide its cost.

Ask whether the design keeps total cost, alternatives, reversibility, and the designer's objective legible. A defensible mental account helps people protect a goal they would endorse under fuller understanding. An exploitative one hides fungibility when the seller benefits from the mistake.
...
A budget rule can require a fresh decision, but some useful actions become easier through repetition in a familiar setting. Setting money aside after payday, for example, may begin as a deliberate comparison and become a routine. This raises a different question: what now prompts the action? [Habits, Wanting, and Self-Control](21-habits-wanting-and-self-control.qmd#habits-wanting-and-self-control) asks what happens when that repeated pattern becomes easier to enact—and harder to revise.

[^ch20-budget-denominator]: The $50 condition had 33 respondents and up to 132 respondent-by-control comparisons per cell. Each entry averages the predicted underconsumption pattern across four unrelated-expense controls, rather than giving a simple percentage of unique respondents.
