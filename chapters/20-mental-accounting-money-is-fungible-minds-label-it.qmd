...
The map describes **representations**, not literal brain compartments or a mandatory sequence. Borrowing while saving, for example, might reflect a psychological boundary or an actual withdrawal penalty. Establish which constraint is operating before prescribing greater flexibility.
...
A label’s influence is not by itself evidence of harm. Ask whether the design keeps total cost, alternatives, reversibility, and the designer's objective legible. A defensible mental account helps people protect a goal they would endorse under fuller understanding. An exploitative one hides fungibility when the seller benefits from the mistake.
