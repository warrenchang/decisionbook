...
Mental accounting describes how people organize financial activities into accounts, code entries as gains or losses, and decide what to evaluate together (Thaler, 1985, 1999). An account can make these operations manageable while hiding a valuable alternative outside its boundary.
...
A budget helps protect money for a purpose, yet the same boundary can make a worthwhile purchase seem unaffordable while funds sit elsewhere. The audit needs to preserve the useful protection and expose the costly restriction. Reconstruct the decision twice:
