# The Social Brain: Learning, Mimicry, and Attribution
...
![Participants’ behavior shifted toward the interaction partner’s mannerism in Chartrand and Bargh’s first experiment. This is an original result redraw with the boundary conditions displayed beside the evidence.](../figures/mimicry-study-redraw.svg){#fig-mimicry-study-redraw fig-alt="An original grouped bar chart shows more face rubbing with a face-rubbing partner and more foot shaking with a foot-shaking partner. A boundary panel says the result is task-specific and that attunement is not mind control."}
...
3. Influence trace: recall one recommendation, review, public commitment, confident source, or group reaction that affected you this week. Mark what changed first—attention, belief, value, identity, or action—and where another mind entered the process.
