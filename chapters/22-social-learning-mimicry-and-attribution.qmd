...
Humans use other people as information, models, audiences, and regulators. Social learning makes cumulative culture possible, but public behavior can mix independent knowledge with copying and pressure. The crowd is strongest evidence when its members observed independently; it becomes a hall of mirrors when each person mainly watched the last.
:::
...
![Social learning supports cumulative culture while also transmitting errors, cascades, and obsolete routines.](../figures/social-learning-culture.svg){#fig-social-learning-culture fig-alt="Five-step social-learning flow from observing to cumulative culture, with a branch to copied-error risks."}
...
![Approximate visual readings from Salganik, Dodds, and Watts (2006), Figure 2: social-influence conditions produced greater cross-world unpredictability than independent-choice benchmarks in both Music Lab experiments. The published article did not print the plotted values.](../figures/cultural-market-study-redraw.svg){#fig-cultural-market-study-redraw fig-alt="A bar chart labels approximate unpredictability values of point zero zero eight four for social influence and point zero zero five zero for independent choice in Experiment 1, and point zero one two eight versus point zero zero three eight in Experiment 2. The panel identifies 7,149 and 7,192 participants, 28 pairwise comparisons among eight social worlds averaged across 48 songs, and an independent benchmark based on 1,000 random splits."}
