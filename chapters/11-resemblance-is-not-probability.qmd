...
Chapter 13 develops the statistical correction in detail. Here the key point is that representativeness answers the question, “How much does this resemble my mental model?” rather than “How probable is this event?”
...
## A face is not a competence measure
...
: From resemblance to probability {#tbl-11-1}
...
Select a person, project, or company that "looks like" a success or failure. State the prototype, the base rate, the sample size, and which features are actually predictive.  
