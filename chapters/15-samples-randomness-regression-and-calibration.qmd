...
There are $\binom{6}{3}=20$ ways to place three heads among six positions. All heads and all tails account for only two sequences. The comparison changes when the question concerns a category rather than one exact sequence.
:::
::::
...
This calculation concerns at least one of the three named delays. It does not establish that the final deadline will be missed.
:::
::::
