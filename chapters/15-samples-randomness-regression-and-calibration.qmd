...
When decisions cannot wait or populations are inherently small, the available sample must still inform action. Report uncertainty, pool comparable evidence cautiously, use hierarchical or shrinkage estimates where appropriate, and identify which conclusion depends on one or two observations.
