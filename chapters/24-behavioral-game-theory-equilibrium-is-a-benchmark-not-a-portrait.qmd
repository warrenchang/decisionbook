...
If others choose uniformly at random, their expected mean is 50. A simple first approximation aims at two-thirds of that, about 33; if others aim at 33, the next step aims near 22, then near 15. This familiar ladder treats the group mean as given, which is more plausible in a large group. Exact best responses in a finite prize game also depend on one’s own influence on the mean, the distribution of others’ choices, and the tie rule.
...
But now imagine that most participants choose between 20 and 40. A player who chooses zero because “zero is the equilibrium” may lose to a player who predicts the group. The equilibrium calculation is correct under its assumptions. A prediction of the actual choice distribution can therefore be more useful for winning than the equilibrium number alone.

::: {.callout-note .core-idea icon=false}
## Core Idea

Predicting a strategic choice requires a view of what players believe about one another. Equilibrium provides one benchmark; limited reasoning and learning provide alternatives. Comparing their predictions helps us explain behavior without treating one observed action as a window into a person’s mind.
:::
