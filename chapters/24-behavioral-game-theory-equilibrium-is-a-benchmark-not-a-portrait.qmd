...
Game theory supplies conditional equilibrium benchmarks for strategically interdependent choices. But real players may represent a different game, reason only a few steps, hold different beliefs, learn from feedback, value others’ outcomes, or use rules that spread through a population; an observed departure does not identify which explanation is correct. Therefore behavioral game theory turns the gap between benchmark and behavior into evidence to explain, not permission to call people irrational or infer a reasoning type from one action.
:::
