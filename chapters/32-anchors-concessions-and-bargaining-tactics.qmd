...
[Chapter 14](14-anchors-halos-decoys-and-escalation.qmd) introduced anchoring as a general judgment mechanism. In negotiation, an anchor is also a strategic act: a first offer can shift the comparison point, reveal information, claim legitimacy, or expose ignorance. The question is therefore not only whether an anchor moves judgment, but who should place it, how credible it is, and what it communicates.
