...
Shrinking concessions can signal an approaching limit, but a perfectly decreasing pattern is not a law and can disadvantage the sender in some conditions (Tey et al., 2021). Treat the pattern as communication. The question is whether each move is deliberate, credible, and connected to exchange.
...
::: {.reference}
Tey, K. S., Hameiri, B., & van Kleef, G. A. (2021). The benefits and burdens of decreasing concession magnitudes in negotiation. Journal of Personality and Social Psychology, 121(2), 261–286.
:::
