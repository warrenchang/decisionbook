# Cognitive Ease: When Easy Feels True
...
## Watch and test: familiarity planted before the choice

In this [short scene from *Focus*](https://youtu.be/BuCMSuLGyJ4), track each earlier exposure that can make the later option feel self-generated and familiar. Before viewing, predict which cue will matter. Afterward, separate **exposure**, **processing ease**, **feeling**, and **choice**. The scene dramatizes a mechanism; it is not evidence for the size or universality of the mere-exposure effect, and no film frame is reproduced here.
:::
...
## Difficulty is not a universal debiasing tool
