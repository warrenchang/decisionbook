...
Before trying to make someone more patient, check whether the way the options are described changes the comparison. The classroom mnemonic **MOST** keeps four option attributes visible:
