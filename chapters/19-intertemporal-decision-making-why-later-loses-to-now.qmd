...
These are illustrative functions. Their parameters describe the plotted comparison rather than estimates for a particular person.
:::
::::
...
Reward-related brain activity is not reserved for immediate gratification. Kable and Glimcher (2007) found that activity in the ventral striatum, medial prefrontal cortex, and posterior cingulate tracked the subjective value of delayed monetary rewards. These fMRI findings challenge a strict division between an impulsive reward system and a patient frontal system; they do not directly measure dopamine or identify a single source of willpower.
