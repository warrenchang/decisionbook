...
The simplest lecture example compares **July at $650,000** with **March at $635,000**. The point is not that these two options must be equivalent for every provider. The designer must first value each package privately and adjust the issues until they are genuinely close in value from its side.
...
The full lecture exercise compares two schedules with the parties' original proposals. Fees below are in **millions of dollars**.
...
The $2.25 million S1 value at $300 million is the arithmetic implied by the stated 0.75% rate. The lecture slide displayed $2.52 million, which appears to be a transposition and is corrected here rather than repeated. More important, both schedules have **cliffs**: S1 drops just above $250 million, while S2 drops at $300 million and again at $400 million. Such discontinuities can weaken incentives or invite strategic reporting near a threshold. A better design might use marginal tiers, a continuous formula, or a bonus for value above a benchmark.
...
Chapter 38 turns from individual agreements to recurring decision systems. Negotiation designs a better conversation and agreement; decision hygiene designs the agendas, roles, forecasts, checks, and feedback through which future decisions will be made.
