...
Figure @fig-bubble-trader-strategies-redraw redraws the reported shares instead of reproducing the journal image used in the lecture notes. The labels describe behavior under one experimental environment and classification rule; they are not permanent investor types or population estimates.
