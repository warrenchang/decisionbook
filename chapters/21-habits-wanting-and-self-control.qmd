...
The [focusing illusion](22-deciding-for-a-better-life-satisfaction-connection-and-meaning.qmd#focusing-illusion) offers a related perspective on how we judge importance. Applied to this example, an urge that fills attention can seem to outweigh everything else about the evening. “I want to scroll” becomes “Nothing matters until this feeling is resolved.” Bringing sleep, tomorrow's plans, and other available activities back into view gives the decision a wider context.
...
If the student opens the feed in bed after several evenings of leaving the phone elsewhere, the old response may still be available when familiar cues recur. Earlier learning can remain available too: in Lally and colleagues' (2010) study, missing one opportunity to perform the new behavior did not materially disrupt the formation process.
...
**Self-compassion** means responding to the difficulty with kindness while taking it seriously. In an experiment by Breines and Chen (2012), students encouraged to respond compassionately after a difficult vocabulary test spent more time preparing for another test than students given no such encouragement. An accepting response to a setback can therefore support renewed effort.

Across further opportunities, observe whether the new response starts with less deliberation and helps the student stop at the intended time. These observations track both habit formation and progress toward the original goal.
...
The groups did **not** differ significantly in reported urges during the experiment. However, participants receiving the instructions reported smoking fewer cigarettes over the following seven days.
:::
::::
