...
![Stable contexts can retrieve a response tendency; action and its consequences then update later cue–response control. An experienced urge is a possible side path, not a required stage.](../figures/habit-loop.svg){#fig-habit-loop fig-alt="A main loop connects context or cue, response tendency, action, immediate consequence, and learning. Learning feeds back to the response tendency. A separate dashed path shows that urge or wanting may occur but is optional."}
