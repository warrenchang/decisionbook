...
::: {.callout-caution .evidence-and-boundary-conditions icon=false}
## Evidence Boundary: addiction is more than a strong habit
...
A habit can make action reliable, and wanting can keep it compelling. Neither tells us whether the repeated pattern produces a satisfying, connected, or meaningful life. [Deciding for a Better Life](22-deciding-for-a-better-life-satisfaction-connection-and-meaning.qmd) takes that next step by asking what the decision—and the routine it creates—is ultimately meant to improve.
