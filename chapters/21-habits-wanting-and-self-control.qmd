...
Uncertain rewards should also be distinguished from **ambiguity**, where the probabilities themselves are unclear. [Chapter 16](16-risk-and-uncertainty.qmd#ambiguity-and-brain-signals) examines why imaging evidence does not support a simple rule that known risk excites the reward system while ambiguity shuts it down.
