...
Much of judgment must be fast: learned patterns and simple cues let people act without rebuilding every decision from scratch. But neither speed nor effort guarantees accuracy; a fluent answer can substitute for the target question, while reflection can rationalize the same mistake. Therefore, this chapter evaluates shortcuts by cue validity, environmental fit, and feedback, and asks when intuition deserves trust or a structured check.
:::
...
![A three-year-old child uses a System 2 strategy—counting on her fingers—to work out 4 + 1. With practice and feedback, this effortful, rule-guided procedure can gradually give way to fast System 1 intuition.](../figures/daughter-finger-counting.png){#fig-daughter-finger-counting fig-alt="A three-year-old child looks down at her hands while counting on her fingers to work out four plus one." width=42% fig-align="center"}
...
Evolution can also shape response thresholds. When a missed danger is much costlier than a false alarm, a cautious criterion can be favored even though it generates many false alarms (Haselton & Buss, 2000; Nesse, 2005). Time pressure may create an additional speed–accuracy trade-off. Signal-detection reasoning shows that a cautious threshold **can** be optimal under stated base rates and error costs; it does not by itself establish that a particular human fear or judgment bias evolved for that function. [Appendix F](../appendices/appendix-f-evolutionary-explanations-of-value-choice-and-rationality.qmd#heuristics-tools-and-biases) separates modeled performance, actual strategy use, and evolutionary origin.
